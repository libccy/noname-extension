...
},help:{"★新版武将":"<li>主要是增强弱将<li>基于标准包武将和一部分其他包武将的主观微型改动优化另外有几个原创lol武将<li>附带武将配音，本人坚决杜绝哑巴武将扩展<li>有BUG或其他问题请去贴吧反馈<li>不定期更新",},config:{  
             new:{
            name:'装逼按钮',
            init:true,
         }
        ...
        character:{
            ...
            new_dianwei:['male','wei',4,['xinqiangxix']],
             ...
             new_xiahouyuan:['male','wei',4,['new_shensu']],		
		         ...
		         new_xiaoqiao:['female','wu',3,['xintianxiang','hongyan']],
            new_zhoutai:["male","wu",4,["xinbuqu","xinfenji"]],
            new_zuoci:["male","qun",4,["qimen","dunjia"]],
            "shen_luxun":["male","wu",3,["slianying","sqianxun"]],
            ...
            zhangzhao:["male","wu",3,["xinzhijian","xinguzheng"]],
            new_caiwenji:["female","qun",3,["xinbeige","xinduanchang"]],
            ...
            dema:["male","shu",4,["chenmo","zhengyi"],[]],
        ...
        characterIntro:{
          ...
          new_dianwei:"己吾城村人。东汉末年曹魏猛将。擅使大双戟，为人壮猛任侠，曾为乡人刘氏报仇，杀人出市，人莫敢近。相貌魁梧，膂力过人。建安二年（197），张绣背叛曹操，典韦为保护曹操而独挡叛军，击杀多人，但最终因寡不敌众而战死。",
           ...
           new_zhanghe:"字儁乂，河间鄚人。三国时期魏国名将。官渡之战时，本为袁绍部将的张郃投降了曹操，并在曹操帐下多立功勋，于曹魏建立后加封为征西车骑将军。诸葛亮六出祁山之间，张郃多次抵御蜀军的进攻，于公元231年在木门道被诸葛亮设伏射死。后谥曰壮侯。为曹魏“五子良将”之一。",
            ...
            xiongnu:"匈奴是个历史悠久的北方民族集团，祖居在欧亚大陆的西伯利亚的寒温带森林和草原的交界地带，他们披发左衽。据《史记·匈奴列传》中记载，匈奴，其先祖夏后氏之苗裔也，曰淳维。唐虞以上有山戎、猃狁、荤粥，居于北蛮，随畜牧而转移。中国古籍中的匈奴是秦末汉初称雄中原以北的强大游牧民族。公元前215年被蒙恬逐出黄河河套地区以及河西走廊地区，西汉前期强大起来，屡次进犯边境。对西汉政权造成了强大的威胁。并控制西域。後为西汉武帝所败，退居漠北分裂为五部。汉元帝时，于五部呼韩邪和亲。后在东汉时分裂为南北匈奴，南匈奴投降汉朝，北匈奴在西迁后消失在中国的古籍中。 南匈奴在五胡十六国时期建立了前赵政权。",
...
tengjiax:{group:["tengjia1","tengjia2"]},
      manbing:{
			audio:2,
			enable:'phaseUse',
			viewAs:{name:'nanman'},
                ...
                ai:{
                    ...
                    effect:{
                        ...
                        if(get.tag(card,'damage')){
                            ...
                            if(target.hp==3) return [1,get.tag(card,'damage')*0];
    ...
    player.draw(player.storage.jifengx-3);
       ...
       player.storage.jifengx-=  player.storage.jifengx;       
            ...
            fengqiang:{
                ...
                unique:true,
                filter:function (event,player){
                return player.storage.jifengx>=3;
            },
                content:function (){ 
       "step 0"
       ...
       "step 1"
            ...
            jifengx:{
                ...
                audio:4,
                filter:function (event,player){
                return player.storage.jifengx<10;
            },
                init:function (player){
            ...
            xintiaoxin:{
                ...
                ai:{
                    ...
                    result:{
                        ...
                        if(target.num('h')<=2||target.num('e')>1) return 0.9;
...
if(trigger.target!=player&&get.color(trigger.card)=='black'&&trigger.card.name=='sha'){
               trigger.target.chooseToDiscard(true,'h');
             }
  if(trigger.target==player&&get.color(trigger.card)=='black'&&trigger.card.name=='sha'){
...
if(card.name=='sha'&&get.color(card)=='black') return [0,0];                        if(card.name=='sha'&&get.color(card)=='red') return [1,1];
            ...
            audio:1,
                ...
                if(result.bool){
                    game.delay(0.5);
                    player.logSkill('xinguzheng',trigger.player);
            ...
            xinbeige:{
                ...
                content:function (){
                "step 0"
                var next=player.chooseToDiscard('he',get.prompt('xinbeige'));
                next.set('ai',ai.get.unuseful2);
                next.set('logSkill','xinbeige');
                "step 1"
                if(result.bool){
    ...
    return false;                      
     if(Math.ceil(event.player.maxHp/3)<event.player.hp)
     return false;
...
player.discardPlayerCard(trigger.target,'e',true);             
            ...
            "bingjianx2":{
                ...
                marktext:"冰",
                intro:{
                    content:"你计算与其他角色距离+2，其他角色与其你计算距离-2，直到你造成伤害",
                },
                mod:{
...
return false;
   ...
   "step 0"
            ...
            xinkeji:{
                ...
                filter:function (event,player){
                return (get.cardCount({name:'zhuge'},player)==0);
            },
                content:function (){
                player.draw();      
                trigger.untrigger();
           ...
           if(player.num('he',{name:'zhuge'})) return 1.5;
           if(player.num('h',{name:'jiu'})) return 2;
           if(player.num('h',{name:'tao'})) return 2;
...
var str='获得了技能';    game.log(player,str,'【'+get.skillTranslation('wushuang')+'】');
      ...
      player.addSkill('zhengyi2');
        ...
        if(result.bool){
            ...
            "滑稽":{
                trigger:{
                    player:["shaEnd","shanBegin","jiuEnd","taoEnd"],
                    source:"shanEnd",
                },
                forced:true,
                content:function (){
        ...
        translate:{
           ...
           baotou_info:"当你使用非转化的【杀】造成伤害时，你可进行一次判定，若结果牌点数大于9，则此【杀】伤害+2。",
          ...
          leidian_info:"出牌阶段，你可以将一张♠花色的牌当【闪电】置于武将牌上。",
            ...
            mubing_info:"锁定技，你的回合外，其他角色的装备牌从装备区失去时，若你装备区没有该类别装备牌，则你可以获得之。",
	          	tengjiax_info:'锁定技，【南蛮入侵】、【万箭齐发】和普通【杀】对你无效。你每次受到火焰伤害时，该伤害+1。',
           ...
           xinyinghun:'英魂',
            ...
            qimen:"奇门",
            "qimen_info":"锁定技，每当你受到伤害时，你摸一张牌，然后随机获得未加入本局游戏的武将的一个技能（主公技、觉醒技除外）。",
            ...
            xinxingxue:"兴学",
            "xinxingxue_info":"结束阶段开始时，你可以令1~3名角色依次摸两张牌并将一张牌置于牌堆顶。",
            ...
            fengqiang:"风墙",
            "fengqiang_info":"锁定技，当你即将受到伤害时，若疾风标记不少于3，则弃置3枚疾风标记，防止即将受到的伤害。",
            jifengx:"疾风",
            "jifengx_info":"锁定技，你回合开始和结束时，都可获得1枚疾风标记，称为“风”，疾风标记的上限为10。",
            ...
            "xinjiang_info":"锁定技，每当你使用（指定目标后）或被使用（成为目标后）一张【决斗】或红色的【杀】时，你可以摸一张牌，若为黑色的【杀】时，你令对方弃置一张手牌。",
         
            "xinzhijian_info":"出牌阶段，你可以将你手牌中的一张装备牌置于一名其他角色装备区里（不得替换原装备），然后摸1~2张牌。",
            "xinguzheng_info":"其他角色的弃牌阶段结束时，你可将其弃置的一张牌返回其手牌，然后获得其弃置的其它牌，锁定技，你的手牌上限+1。",
            "xinbeige_info":"一名角色每受到【杀】造成的一次伤害，你可以弃一张牌，并令其进行一次判定，判定结果为：♥该角色回复X点体力；♦︎该角色摸2×X张牌；♣伤害来源弃2×X张牌；♠若伤害来源武将牌正面朝上，则令其武将牌翻面，然后你摸X张牌，X为该角色受到伤害值。",
            ...
            "xinjushou_info":"结束阶段开始时，你可以摸3+X张牌，然后将你的武将牌翻面，（X等于场上存活角色的数量)。",
            zhewu:"折舞",
            "zhewu_info":"锁定技，你使用[杀]的次数上限+2；你的[杀]或[决斗]对目标造成伤害时，你可以摸一张牌。",
            zhufeng:"逐锋",
            "zhufeng_info":"你使用[杀]对目标造成伤害时，若对方当前体力值等于X或更低，此[杀]伤害+X，X等于其最大体力值的1/3，每阶段限一次。",
            kuangzhan:"狂战",
            ...
            "xinjizhi_info":"锁定技，每当你使用或打出一张非转化的锦囊牌，你可亮出牌堆顶的2~3张牌，然后获得其中的锦囊牌并展示之。",
            ...
            "xinkeji_info":"锁定技，若你在出牌阶段没有使用[诸葛连弩]，则你可以摸一张牌并跳过弃牌阶段。",
            "xinkurou_info":"出牌阶段，你可以流失一点体力并摸3张牌。",
            "xinyingzi_info":"锁定技，摸牌阶段，你可以额外摸一张牌，你的手牌上限+2+X，X等于你装备区牌的数量的一半且向上取整；你不能成为[兵粮寸断]的目标。",
            ...
            zhengyi:"正义",
            "zhengyi_info":"锁定技，你的【杀】指定体力等于1的目标时，此【杀】不可被【闪】响应，且伤害+1。",
            nuqi:"怒气",
            "nuqi_info":"锁定技，结束阶段，若你已受伤且\"暴怒\"标记不少于3枚，你弃置3枚\"暴怒\"标记，回复一点体力。",
            xunjie:"迅捷",
            "xunjie_info":"锁定技，你计算与其他角色的距离时，始终-1；只要你的体力值为2点或更低，其他角色计算与你的距离时，始终+1。",
            jielue:"劫掠",
            "jielue_info":"锁定技，你回合结束或对其他角色造成伤害时，抽取每名敌方角色一张手牌；你的手牌上限不会因体力值的减少而减少。",
            zhimang:"致盲",
            "zhimang2":"致盲",
            "zhimang_info":"出牌阶段限一次，你可以将一张♠或♣花色手牌置于一名角色的武将牌上，该角色造成的下一次伤害丢失，然后弃置两张牌。",
            liuxing:"流星",
            "liuxing_info":"锁定技，你的攻击范围+1；其他角色计算与你的距离时，始终+1。",
            shuangdiao:"双雕",
