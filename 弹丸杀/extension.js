    ...
    precontent: function(cfg) {
        ...
        character.dangan={
		                    ...
		                    filter: function(event, player) {
		                        ...
		                        if (notonly) {
		                            if (player.name2) {
		                                ...
		                                var n2 = player.name2;
		                                if (n1 == 'dan_kamukura') n1 = 'dan_rixianga';
		                                if (n2 == 'dan_kamukura') n2 = 'dan_rixianga';
		                                player.init(n1, n2);
		    ...
		    translate:{
		        ...
		        nuller3_info: "",
		        nuller4: "神秘",
		        nuller4_info: "出牌阶段限1次，你可以使自己翻面，然后与一名场上的其他角色交换位置。",
		        tianzhong1: "御兽",
        ...
        var cPack = character.dangan.character;
        if(_status.evaluatingExtension){
            for(var i in cPack){cPack[i][4].push('db:extension-弹丸杀:'+i+'.jpg');}
        }
        else{
        	for(var i in cPack){cPack[i][4].push('ext:弹丸杀/'+i+'.jpg');}
        }
        config.characters.push('dangan');
