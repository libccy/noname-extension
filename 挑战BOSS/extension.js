...
},config:{},help:{"挑战BOSS":"<li>本次更新的可能会有bug，发现请反馈。其他自行探讨不一一细说了。不建议在其他模式使用此扩展武将，其他模式已开放使用。这种AI会打队友，让电脑选到的话你懂的<li>作者不喜欢变态的武将差不多就好了<li>配置低的设备不建议使用此扩展<li>作者贴吧id：一瞬间丶遗忘，自制BOSS，神将强度稍高，欢迎用diy武将挑战，要是用那种开场就令目标失去所有技能那种diy就没意思了，不如直接失去所有体力值上限岂不美哉？用常规武将挑战成功的，那恭喜你即将走上人生巅峰<li>有任何问题BUG、意见或建议请到贴吧反馈，不定期更新，如果你喜欢的话可以催更哦<li>附带武将技能配音哦，你确定不来吗？<li>非二次元武将，导入后直接在挑战模式使用",},                       
         package:{
        character:{		
        character:{
         boss_machao:["male","shen",12,["mashu","boss_pimi","boss_xionglie"],['boss','bossallowed',"des:马超（176年－223年1月），字孟起，司隶部扶风郡茂陵（今陕西杨凌五泉镇）人，东汉卫尉马腾之子，汉末群雄之一，蜀汉开国名将。早年随父征战，平阳之战大破并州刺史高干和南匈奴呼厨泉的联军。后马腾入京，马超拜将封侯割据雍州，潼关之战被曹操击败，退守凉州。失败后依附张鲁，又转投刘备。带头上表刘协扶刘备称王，又辅佐刘备称帝。于章武二年十二月病逝（223年1月），终年47岁，追谥威侯。有阵中剑术“出手法”流传后世。"]],
         boss_tiaozhan:["male","wei",7,["boss_hudui","tiaozhan_bianshen"],['boss','bossallowed',"des:挑战？"]],
         boss_kelian:["female","shu",8,["boss_qingxu","kelian","tiaozhan_bianshen2"],['hiddenboss',"des:汝欲返性情而无由入，可怜哉！"]],
         boss_tiaopi:["male","wu",9,["boss_qingxu","tiaopi","tiaozhan_bianshen3"],['hiddenboss',"des:爱玩爱闹，不听劝导。"]],
         boss_yinxian:["male","qun",10,["boss_qingxu","yinxian","tiaozhan_bianshen4"],['hiddenboss',"des:表面和善,暗地不怀好意的"]],
         boss_huaji:["male","wei",11,["boss_qingxu","huaji","tiaozhan_bianshen5"],['hiddenboss',"des:在嘲笑和插科打诨中，揭露自相矛盾之处，达到批评和讽刺。"]],        
        boss_fennu:["male","wu",12,["boss_qingxu","fennu","fennu1","tiaozhan_bianshen6"],['hiddenboss',"des:愤怒，不仅仅指当愿望不能实现或为达到目的的行动受到挫折时引起的一种紧张而不愉快的情绪，而如今也存在于对社会现象以及他人遭遇甚至与自己无关事项的极度反感；后者多发于社会性动物群体之中，成语如“义愤填膺”。愤怒被看作一种原始的情绪，它在动物身上是与求生、争夺食物和配偶等行为联系着的。"]],
        boss_yishunjianyiwang:["female","shen",3,["the_mass","boss_shunjian","boss_yiwang","boss_shuitie","boss_wanzun"],['hiddenboss',"des:水的清澈，并非因为它不含杂质，而是在于懂得沉淀；心的通透，不是因为没有杂念，而是在于明白取舍。"]],
         boss_cwj:["female","shen",2,["boss_beifen","boss_bieli"],["zhu","boss","bossallowed","des:蔡琰，字文姬，又字昭姬[1]。生卒年不详。东汉陈留郡圉县（今河南开封杞县）人，东汉大文学家蔡邕的女儿。初嫁于卫仲道，丈夫死去而回到自己家里，后值因匈奴入侵，蔡琰被匈奴左贤王掳走，嫁给匈奴人，并生育了两个儿子。十二年后，曹操统一北方，用重金将蔡琰赎回，并将其嫁给董祀。[2]蔡琰同时擅长文学、音乐、书法。《隋书·经籍志》著录有《蔡文姬集》一卷，但已经失传。现在能看到的蔡文姬作品只有《悲愤诗》二首和《胡笳十八拍》。"]],
         boss_simayan:["male","shen",3,["boss_tongyi","boss_shemian"],["zhu","boss","bossallowed","des:司马炎（236年－290年5月16日），字安世，河内温县（今河南省温县）人，晋朝开国皇帝（265年－290年在位）。晋宣帝司马懿之孙、晋文帝司马昭嫡长子、晋元帝司马睿从父。"]],
         boss_jianwu:["male","shen",100,["victory","boss_xiushen","boss_pojia","boss_jianqi","boss_jianyu"],["zhu","boss","bossallowed","des:無敵是我，我就是無敵！劍術天下無雙！"]],
        BOSS_diaochan:["female","shen",7,["boss_biyue","boss_guose","boss_meihuo"],["zhu","boss","bossallowed","des:中国古代四大美女之一，有闭月羞花之貌。司徒王允之义女，由王允授意施行连环计，离间董卓、吕布，借布手除卓。后貂蝉成为吕布的妾。"]],
        BOSS_xuhuang:["male","shen",12,["boss_jieliang"],["zhu","boss","bossallowed","des:徐晃（？－227年），字公明，河东杨（今山西洪洞东南）人。三国时期曹魏名将。本为杨奉帐下骑都尉，杨奉被曹操击败后转投曹操，在曹操手下多立功勋，参与官渡、赤壁、关中征伐、汉中征伐等几次重大战役。樊城之战中徐晃作为曹仁的援军击败关羽，因于此役中治军严整而被曹操称赞“有周亚夫之风”。曹丕称帝后，徐晃被加为右将军，于公元227年病逝，谥曰壮侯。"]],
        BOSS_yuji:["male","shen",5,["boss_yaohuo"],["zhu","boss","bossallowed","des:于吉（？-200年，一作干吉、干室）东汉末年黄老道代表人物之一，史书有两种说法：（1）认为其即《太平经》作者。《后汉书·襄楷传》：“顺帝时，琅邪宫崇诣阙，上其师干吉于曲阳泉水上所得神书百七十卷，皆缥白素朱介青首朱目，号《太平青领书》。”（2）认为其乃三国时道士，《三国志·孙策传》注引《江表传》：“时有道士琅邪于吉，先寓居东方，往来吴会，立精舍，烧香读道书，制作符水以治病，吴会人多事之。”后为孙策所杀。"]],
        BOSS_zuoci:["male","shen",20,["boss_piaomiao","boss_qimen","boss_dunjia"],["zhu","boss","bossallowed","des:左慈（156？--289？），字元放，汉族，安徽庐江郡人，东汉末年方士。少明五经，兼通星纬，学道术，明六甲，传说能役使鬼神，坐致行厨。见汉祚将尽，天下向乱，叹曰：“值此衰运，官高者危，财多者死。当世荣华，不足贪矣。”在安徽天柱山中得石室而精思。左慈授予葛玄道家真经数部。"]],
        BOSS_zhangfei:["male","shen",7,["shemao","boss_nuxiao"],["zhu","boss","bossallowed","des:张飞（？－221年），字益德[1]，幽州涿郡（今河北省保定市涿州市）人氏，三国时期蜀汉名将。刘备长坂坡败退，张飞仅率二十骑断后，据水断桥，曹军没人敢逼近；与诸葛亮、赵云扫荡西川时，于江州义释严颜；汉中之战时又于宕渠击败张郃，对蜀汉贡献极大，官至车骑将军、领司隶校尉，封西乡侯，后被范强、张达刺杀。后主时代追谥为“桓侯”。在中国传统文化中，张飞以其勇猛、鲁莽、嫉恶如仇而著称，虽然此形象主要来源于小说和戏剧等民间艺术，但已深入人心。"]],
         BOSS_zhanshen:["male","shen",8,["chitu","shenwu","zhanshen"],["zhu","boss","bossallowed","des:吕布（？－199年2月7日[1]），字奉先，五原郡九原县人（今内蒙古包头九原区），东汉末年名将，汉末群雄之一。先后为丁原、董卓的部将，后与司徒王允合力诛杀董卓，旋即被董卓旧部李傕等击败，依附袁绍。与曹操争夺兖州失败后，吕布袭取徐州，割据一方。建安三年十二月（199年2月）吕布于下邳被曹操击败并处死。"]],
            BOSS_shenhua:["male","shen",0,["baonu","wushuang","feijiangx","shenshi","shensha","shenmie"],["zhu","boss","bossallowed","des:吕布（？－199年2月7日[1]），字奉先，五原郡九原县人（今内蒙古包头九原区），东汉末年名将，汉末群雄之一。先后为丁原、董卓的部将，后与司徒王允合力诛杀董卓，旋即被董卓旧部李傕等击败，依附袁绍。与曹操争夺兖州失败后，吕布袭取徐州，割据一方。建安三年十二月（199年2月）吕布于下邳被曹操击败并处死。"]],
        },
        translate:{
...
player.maxHp=Math.floor(player.maxHp*1.15);
      player.hp=Math.floor(player.hp*1.15);
      player.update();
      }},			
     fennu2:{
     ...
     fennu3:{
      ...
      priority:-Infinity,
			content:function(){
     trigger.num=Math.min(2,trigger.num);
     }},     
     huaji:{
  ...
  player.draw(3);
   ...
   trigger:{global:['phaseBegin']},
     ...
     return event.player!=player;
      ...
      "step 0"
      if(Math.random()<=0.25){
      trigger.player.loseHp(player.maxHp);
      }    
    else{
player.draw(3);
trigger.player.chooseToDiscard(true,'he',Math.ceil(trigger.player.num('he')/2));   
trigger.player.damage(Math.max(1,Math.ceil((player.maxHp-player.hp)/2)),['fire','thunder','poison'].randomGet());    
      }  
     }
   },
   boss_shuitie:{   
...
animationStr:"厉害了！我的哥！！",
   ...
   tiaozhan_bianshen4:{		
    ...
    tiaozhan_bianshen6:{		
     ...
     boss_xionglie:{ 
     group:['boss_xionglie1','boss_xionglie2','boss_xionglie3','boss_xionglie4','boss_xionglie5','boss_xionglie6'],
    ai:{
                    noe:true,
                    threaten:8.1,                   
                    effect:{
...
if(player.countCards('h','sha')>1&&card.name=='zhuge') return [1,Infinity];             
         ...
         if(card.name=='jiu') return [1,Infinity];         
        if(card.name=='sha') return Infinity;
               },
                    },
                },
...
current.damage(Math.max(1,Math.floor(current.maxHp/3)));        
     ...
     boss_xiushen:{
     group:['boss_xiushen1','boss_xiushen2'],     
			trigger:{player:'phaseBegin'},
     forced:true, 
     audio:3,     
			content:function(){		
   ...
   zhanshen:{
    ...
    zhanshen5:{
     ...
     chitu:{
       ...
       yinxian_info:'<span class="greentext">锁定技'+'</span>，1、其他角色使用或打出牌时，你有75%的几率抽取其一张牌，并有35%几率视为对其他角色使用一张[万箭齐发]或[南蛮入侵]；2、你使用[万箭齐发]或[南蛮入侵]指定目标后，你无视其防具', 
    		fennu_info:'<span class="greentext">锁定技'+'</span>，1、游戏开始时，你获得1枚愤怒标记，每当你造成或受到一点伤害，你获得一枚愤怒标记；2、你造成伤害时，伤害+等同于愤怒标记的数量；3、每当你回合开始时，你的体力上限和体力值增加15%向下取整；4、每当你在回合外受到伤害或流失体力时，当前回合结束，你执行一个额外回合；5、你每次受到伤害或流失体力时，最多承受2点伤害和最多流失2点体力（防止多余的伤害和体力流失)',
       huaji_info:'<span class="greentext">锁定技'+'</span>，1、每当其他角色使用以下牌指定你为目标时，你有几率令该角色流失X点体力，X为其已损失的体力值，且至少为1，(【杀】、【决斗】、【火攻】、【南蛮入侵】、【万箭齐发】、【铁索连环】、【借刀杀人】、【顺手牵羊】、【过河拆桥】、【乐不思蜀】、【兵粮寸断】、【草木皆兵】、【弃甲曳兵】、【声东击西】)，你使用这些牌指定其他角色为目标时，有几率令其受到X点属性伤害，X为其最大体力值的30%，且至少为1；2、当其他角色回复体力或使用【无中生有】、【无懈可击】、【五谷丰登】、【增兵添灶】、【金蝉脱壳】时，你有75%几率取消之，然后你回复一点体力，并摸三张牌',
       boss_shunjian_info:'<span class="greentext">锁定技'+'</span>，回合结束时，你有20%的几率将体力回复至最大体力值；否则你摸三张牌',
       ...
       boss_wanzun_info:'<span class="greentext">锁定技'+'</span>，其他角色回合开始时，你有25%的几率令其失去X点体力，X为你最大体力值；否则你摸三张牌，并令其弃置一半牌向上取整，然后你对其造成X点属性伤害，X改为你已损失的体力值的一半向上取整，且至少为1',
       ...
       boss_pimi_info:'<span class="greentext">锁定技'+'</span>，你使用【杀】指定一名目标时，若该角色装备区牌数不大于你，则此【杀】伤害+X，X为0~999的随机值；若此为属性【杀】时，与该角色横置的其他角色传导此伤害时，伤害按X叠加',
       ...
       boss_xiushen_info:'<span class="greentext">锁定技'+'</span>，1、摸牌阶段你不摸牌；2、回合开始时，你摸3~7张牌；3、当你武将牌正面朝上被翻面或成为[乐不思蜀]的目标时，你有75%的几率取消之；4、你的手牌上限始终为15',
       boss_jianqi_info:'<span class="greentext">锁定技'+'</span>，你的【杀】有几率造成两倍伤害',
       victory_info:'<span class="bluetext" style="color:	#cd7f32">限定技'+'</span>，1、游戏开始时，你摸3张牌，然后随机播放一首战歌；2、当体力值低于5时，你将体力回复至最大体力值的25%~40%，然后获得技能：<span class="bluetext" style="color:	#5F9EA0">疗伤'+'</span>；并将手牌数补至你当前体力值，再随机播放一首战歌，然后失去技能：<span class="bluetext" style="color:	#5F9EA0">战歌'+'</span>',
       ...
       boss_piaomiao_info:'<span class="greentext">锁定技'+'</span>，回合开始时，你令所有敌方角色弃置一半牌(向上取整)，且至少为1，并对其造成X点雷电伤害，X为其最大体力值的1/4(四舍五入取整)，且至少为1',
            boss_qimen_info:'<span class="greentext">锁定技'+'</span>，每当你造成或受到一次伤害时，你随机获得未加入本局游戏的武将的一个技能（主公技、觉醒技除外)；然后你摸X张牌，X为你已损失的体力值，并获得对你造成伤害的其他角色的一半牌且向上取整',
