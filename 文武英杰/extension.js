...
translate:{
    ...
    "wwyj_xiyuan":"释援",
    "wwyj_xiyuan_info":"出牌阶段限一次，你可以选择交给至多X名有手牌的其他角色各一张手牌，然后令这些角色分别交给你一张其他的手牌(X为场上手牌数小于其体力上限的角色数且至少为1)",
    "wwyj_xuanxia":"玄侠",
...
var liblist = [
			   ...
			   ['<span class="bluetext">释援</span>：出牌阶段限一次，你可以选择交给至多X名有手牌的其他角色各一张手牌，然后令这些角色分别交给你一张其他的手牌(X为场上手牌数小于其体力上限的角色数且至少为1)<br><span class="bluetext">勤言</span>：<font color=#f00>锁定技</font> 回合内，当你失去所有手牌后，你将手牌补至当前体力值且你本回合对本回合发动“释援”的目标使用牌时，无视距离和次数限制'],
