...
skill:{
 "xwj_xwugeng_yinguo":{
    ...
    filter:function (event,player){		
		...
		if(!player.getEquip(2)&&event.nature) return false;
        return true;
    },
    content:function (){                
...
player.revive(player.maxHp)
 ...
 translate:{
            ...
            "xwj_xwugeng_chenjie_info":"<font color=#F0F>因果转轮</font>出牌阶段限一次，你可令场上所有拥有“因果”标记的角色受到一点来源为你的伤害，若如此做，这些角色弃掉一个“因果”标记，然后你变身为“恶禅”状态，失去技能<font color=#F0F>惩戒</font>、<font color=#F0F>空镜</font>、<font color=#F0F>助战</font>，获得技能<font color=#F0F>惩罪</font>、<font color=#F0F>金刚</font>",
			...
			"xwj_xwugeng_jingang_info":"<font color=#F0F>金刚不灭之身</font>当你没装备防具时，你防止受到非属性伤害",
