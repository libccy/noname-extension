...
var skill=trigger.player.skills.randomGet()
    ...
    var chat=['吃我一拳，看是你的骨头硬还是我的拳头硬','点解？点解？点解要逼我出手？'].randomGet();
        ...
        next.set('prompt',get.prompt('chengyi',trigger.player));
        "step 1"
        if(result.control=='移动装备'){
            player.logSkill('chengyi',trigger.player);
        ...
        translate:{
            ...
            chengyi:"承艺",
            "chengyi_info":"每当你造成伤害后，你可以选择一项：将受到伤害的角色装备区里的一张牌移动至你装备区里的相应位置（不可替换原装备）；或摸一张牌。",
        },
    },
    ...
    version:"20171118",
},files:{"character":["kanjiulang.jpg"],"card":[],"skill":[]}}})