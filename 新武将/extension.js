	...
	game.import('character',function(){
			var xwugeng={
				...
				character:{
					...
					"xwj_xwugeng_xuanfeng":["male","shen",3,["xwj_xwugeng_shensu","xwj_xwugeng_baofeng","xwj_xwugeng_zhengkong"],[]],
...
skill:{
 "xwj_xwugeng_shensu":{
        ...
        globalTo:function (from,to,current){
           return current+2*(to.maxHp-to.hp);
        },
    },
            },
     ...
     player.die();    
       ...
       player.chooseTarget('选择发动神技【真空】的目标',lib.translate.xwj_xwugeng_zhengkong_info,true,function(card,player,target){
        ...
        "step 1"
        if(result.bool){
            player.$skill('神技•真空','fire','red','avatar'); 
...
content:function (){
 ...
 translate:{
           ...
           "xwj_xwugeng_shensu_info":"锁定技，你的进攻距离无限，你的防御距离+2X（X为你损失的体力值）",           
            ...
            "xwj_xwugeng_baofeng_info":"<li>当你受到伤害后，你可选择令一名其他角色的进攻距离-X（X为其体力值），并视为对其使用一张【杀】<li>每两轮限一次机会，当一名其他角色进入濒死状态时，你可选择令其体力回复至1，并且其防御距离永久+Y（Y为其损失的体力值）",
            "xwj_xwugeng_zhengkong":"真空",
            "xwj_xwugeng_zhengkong_info":"<font color=#F0F>神技•真空</font> 当你一次受到大于一点的伤害后，你可选择令一名其他非主公角色，在其回合开始起计时，九九八十一秒后，其因窒息而死亡。<font color=#F0F>与十刑互相克制</font> ",
	           "xwj_xwugeng_tian":"天",
