game.import("extension",function(lib,game,ui,get,ai,_status){return {name:"新武将",editable:false,content:function (config,pack){
    ...
    card:{
        ...
        translate:{
            weishou:"尾兽",
            "weishou_info":"宠物牌（宝物，收集查克拉），当场上有其他角色使用【桃】时，你可以弃掉【尾兽】，阻止【桃】的结算并将其收为手牌",
        },
...
var chat=['只有瞬间的绚丽，才是艺术','这个艺术，终会得到世人的赞美'].randomGet();
        ...
        if(card){
            var name=card.name;                                if(event.name=='tao'&&get.itemtype(event.cards)=='cards'&&get.position(event.cards[0])=='d'&&event.player!=player&&name&&name.indexOf('weishou')!=-1) return true;
        }
        return false;
    },
                check:function (event,player){
   ...
   "step 2"
    ...
    player.$gain2(trigger.cards);
        ...
        translate:{
            ...
            "yuedu2":"幻术",
            "yuedu2_info":"直到回合结束，该角色不能使用或打出手牌且其非锁定技失效，若你没赢，你可令该角色回复一点体力。",
            "yuedu3":"月读",
            "yuedu3_info":"与其距离为1",
            baozi:"孢子",
            ...
            huigu:"灰骨",
            "huigu_info":"（白眼、共杀灰骨）出牌阶段限一次，你可以令攻击范围内的一名有手牌的其他角色随机展示一张手牌，然后你须弃置其一张牌",
            feiniao:"飞鸟",
