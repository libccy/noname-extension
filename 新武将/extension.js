...
"xwj_xhuoying_kanjiulang":"勘九郎，日本忍者题材漫画《火影忍者》中的男性角色。风之国·砂隐村第四代风影罗砂之子，手鞠的弟弟，我爱罗的哥哥。他是一名傀儡师，特征是身穿黑色连身装以及涂绘在脸上的紫色状纹，且每次现身总有新的傀儡术。 既爱好策略，也有冲动的一面。原本与手鞠一样对强大而残暴的弟弟有所畏惧，后来随着我爱罗性情的改变，勘九郎也努力和弟弟搞好关系，兄弟之情渐渐显示出来。在五影会谈中，勘九郎和手鞠一起担任我爱罗的护卫。第四次忍界大战中，勘九郎作为奇袭部队的队长。最终话的新五影会谈中，担任我爱罗的护卫。",
 ...
 "xwj_xhuoying_xiaonan":"小南，日本动漫《火影忍者》中的人物。“晓”组织的创立者之一，而且是其中唯一一个女性成员，代号“白”（白虎），被称为“天使”。她是第二次忍界大战时雨隐村的孤儿，曾经和弥彦、长门一起接受过自来也的忍术指导。后来和长门一起被漩涡鸣人的真诚所感动，重拾保护世界和平的信心。曾设计六千亿张起爆符诛杀宇智波带土，但失败。最终为了保护长门的遗体的轮回眼而被自称为“宇智波斑”的“面具男”（宇智波带土）杀死。",
			...
			"xwj_xhuoying_kakasi":['xwj_xhuoying_daitu'],
	...
	game.import('character',function(){
			var xwugeng={
				...
				character:{
					...
					"xwj_xwugeng_xuanfeng":["male","shen",4,["xwj_xwugeng_baofeng","xwj_xwugeng_zhengkong"],[]],
...
skill:{
	 ...
	 "xwj_xwugeng_baofeng3":{
        ...
        if(result.bool){
            ...
            result.targets[0].addSkill('xwj_xwugeng_baofeng4','phaseEnd');           
        }
    },
                ai:{
                    maixie:true,
     ...
     player.die();    
            ...
            xwj_xwugeng_baofeng:{
                forced:true,
                locked:true,
                group:["xwj_xwugeng_baofeng1","xwj_xwugeng_baofeng2"],
            },
        ...
        return (get.attitude(player,event.source)<=0);
                ...
                content:function (){
        "step 0"
        player.chooseTarget(get.prompt('xwj_xwugeng_zhengkong'),function(card,player,target){
            return player!=target;
        }).ai=function(target){            
            var player=_status.event.player;
            if(get.attitude(_status.event.player,target)>=0) return 0;       
...
content:function (){
 ...
 translate:{
	 "xwj_xwugeng_xuanfeng":"玄风圣王",
	  "xwj_xwugeng_baofeng3":"风",
            "xwj_xwugeng_baofeng3_info":"防御距离+X（X为你损失的体力值）",
            "xwj_xwugeng_baofeng4":"风",
            "xwj_xwugeng_baofeng4_info":"进攻距离-Y（Y为你的体力值）",
            "xwj_xwugeng_baofeng2":"暴风",
            "xwj_xwugeng_baofeng2_info":"限定技，当一名其他角色进入濒死状态时，你可选择令其体力回复至1，并且其防御距离永久+X（X为其损失的体力值）",
            "xwj_xwugeng_baofeng1":"暴风",
            "xwj_xwugeng_baofeng1_info":"回合结束或你的体力值发生变化时，你可令一名其他角色的进攻距离-Y，直到其回合结束（Y为其损失的体力值）",
            "xwj_xwugeng_zhengkong2":"真空",
            "xwj_xwugeng_zhengkong2_info":"锁定技，你的回合开始起计时，九九八十一秒后，你因窒息而死亡",
            "xwj_xwugeng_baofeng":"暴风",
            "xwj_xwugeng_baofeng_info":"<li>回合结束或你的体力值发生变化时，你可令一名其他角色的进攻距离-Y，直到其回合结束（Y为其损失的体力值）<li>限定技，当一名其他角色进入濒死状态时，你可选择令其体力回复至1，并且其防御距离永久+X（X为其损失的体力值）",
            "xwj_xwugeng_zhengkong":"真空",
            "xwj_xwugeng_zhengkong_info":"当你一次受到大于一点的伤害后，你可选择令一名其他角色在其回合开始起计时，九九八十一秒后，其因窒息而死亡",
	 "xwj_xwugeng_tian":"天",
...
},help:{"新武将":"<li>此扩展始创于2017年8月，汇集了部分三国新武将、《火影忍者》、《秦时明月》、《封神纪》等作品的人物，技能强度略高，可联机，但版本必须要一致，若不一致请先到游戏内更新到最新版本的扩展。若有更好的技能设计或建议可在贴吧留言哦！<li>新增卡牌：【手里剑】2张，【写轮眼】、【九尾】、【漩涡面具】、【苦无】、【猴子】各1张<li>游戏时请关闭“火影忍者”武将栏的新版替换开关，否则会有部分武将的技能会缺失<li>游戏时若遇见卡死情况，打开兼容模式提高扩展的兼容性即可解决。目前可能会引起卡死情况的武将有；“志村团藏”的“惑梦”不开兼容模式会卡死，此时只需打开兼容模式即可……<li>卡卡西的技能“复制”选择与该次已选择的角色一致时会失败，若想保持复制的技能不变，可在提示选择角色时点“取消”即可<li>【编码】Sukincen<li>【配图】Sukincen<li>【录制配音】Sukincen"},config:{},package:{
    character:{
        character:{
        },
        translate:{
