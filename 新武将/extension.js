...
characterIntro:{
     	"xwj_xwugeng_tian":"天，龙族，本名“黑龙”，香港漫画《封神纪》及中国大陆改编3D动画《武庚纪》中登场的男性角色。神族之主，亦称“天帝”。在神族中地位特殊，而且寿命远远超过其余神众。 平时生活在龙的体内，拥有无色界神力。无色界神力是神力中最罕见的一个种类，用于压抑声音、气味、力气、光、攻击、防御等，让对手的全部能力大幅降低、黯然无色。是上古与冥族交战取得世界支配权的远古神族，被不死鸟称为是“黑龙之主”，与白龙、黄龙、赤龙、飞龙同为远古神族五大古龙之一。",
					...
					"xwj_xwugeng_xuanfeng":"玄风圣王，港漫《封神纪》五圣王之一，主万象界神力之风象，能瞬间引发超强风暴，曾一招将十刑吹到千里之外，也用此招从古龙手里救走心月葵。绝招：暴风、银翼破空、无形剑，神技——真空。",
					"xwj_xwugeng_tianwu":"天武圣王，港漫《封神纪》五圣王之一，主万象界神力。曾任“阎部大神”，性格刚烈，作战时十分勇猛，为人讲义气，对神眼十分忠诚。其为攻击型战士，破坏力极强，每一击都能引起地动山摇，曾一招“天地震怒”引起了地震和海啸。神技：真武大霹雳（大范围爆炸，剧烈震碎，把任何实物震碎。）、怒拳、神怒霹雳、大地之力·天地震怒（说白了就是地震，对地面的对手造成伤害，对空中无效。）、大地之怒（附带连环爆炸效果的拳击，可造成强烈地震）",
...
skill:{		
    ...
    content:function (){
        ...
        trigger.untrigger();    
        event.current=player.next;
          var chat=['敢动我神族大祭司，想必已做好灭亡的觉悟了','十刑竟能战胜天魁？有点意思！'].randomGet();
            player.say(chat);    
        "step 1"
	 ...
	 "xwj_xwugeng_pili_info":"<font color=#F0F>神技•真武大霹雳</font> 每两轮限一次，若你的体力值不大于当前存活的角色数，你可弃置X张相同颜色的手牌，并对X名攻击范围内的其他角色各造成X点伤害（X为你以此法弃置的手牌数）", 
           ...
           "xwj_xwugeng_shensu_info":"锁定技，你的进攻距离＋X（X为你的体力值），你的防御距离+Y（Y为你损失的体力值）",           
            ...
            "xwj_xwugeng_zhengkong_info":"<font color=#F0F>神技•真空</font> 当你流失体力或一次受到大于一点的伤害后，你可选择令一名其他非主公角色，在其回合结束起计时，九九八十一秒后，其因窒息而死亡。<font color=#F0F>与十刑互相克制</font> ",
          	 ...
          	 "xwj_xwugeng_xuemao_info":"你使用的【杀】可指定任意名角色。出牌阶段限一次，你可以展示牌堆顶的一张牌，若该牌为：装备牌，你使用之并回复一点体力；锦囊牌，你弃置此展开的牌后再摸两张牌；基本牌，你弃置此展开的牌，视为对任意一名其他角色使用一张不计距离、不计入次数限制的【杀】",	 
