        ...
        trigger.finish();
            ...
            reshenwei:{
                ...
                viewAs:{
                    ...
                    suit:"spade",
                    number:2,
                    cards:[{"node":{"image":{},"info":{},"name":{},"name2":{},"background":{},"intro":{},"range":{}},"storage":{},"vanishtag":[],"_uncheck":[],"suit":"spade","number":2,"name":"hanbing","cardid":"9140533383","clone":{"name":"hanbing","suit":"spade","number":2,"node":{"name":{},"info":{},"intro":{},"background":{},"image":{}},"_transitionEnded":true,"timeout":4468},"original":"h","timeout":4438}],
                },
                filter:function (event,player){
...
if(card.name=='sha'&&range[1]!=-1) range[1]++;
  ...
  var chat=['阴封印•创造再生——百豪之术'].randomGet();
       ...
       var chat=['我就看看不说话','潜入成功，幸好没人发现老夫','美女，我是来取材的','大丈夫为人坦荡，看下内裤算什么？'].randomGet();
        ...
        'step 0' 
        player.draw();
        player.$skill('长生不死','fire','red','avatar');
        'step 1'
        player.chooseToCompare(target);          
...
var chat=['我有那么谦虚？看来也不错','岚遁……'].randomGet();
    ...
    version:"20171118",
},files:{"character":["daluyi.jpg"],"card":["jiuwei.png"],"skill":[]}}})