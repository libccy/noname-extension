	 ...
	 "xwj_xwugeng_pili_info":"<font color=#F0F>神技•真武大霹雳</font> 每两轮限一次，若你的体力值不大于当前存活的角色数，你可弃置X张相同颜色的手牌，并对X名攻击范围内的其他角色各造成X点伤害（X为你以此法弃置的手牌数）", 
           ...
           "xwj_xwugeng_shensu_info":"锁定技，你的进攻距离＋X（X为你的体力值），你的防御距离+Y（Y为你损失的体力值）",           
            ...
            "xwj_xwugeng_zhengkong_info":"<font color=#F0F>神技•真空</font> 当你流失体力或一次受到大于一点的伤害后，你可选择令一名其他非主公角色，在其回合结束起计时，九九八十一秒后，其因窒息而死亡。<font color=#F0F>与十刑互相克制</font> ",
          	 ...
          	 "xwj_xwugeng_xuemao_info":"出牌阶段限一次，你可以展示牌堆顶的一张牌，若该牌为：装备牌，你回复一点体力并使用之；锦囊牌，你弃置此展开的牌后再摸两张牌；基本牌，你获得此牌，视为对任意一名其他角色使用一张不计距离、不计入次数限制的【杀】",	 
          	 "xwj_xwugeng_xuemao2_info":"你使用的【杀】可指定任意名角色，直到回合结束",
          	 "xwj_xwugeng_baiqian":"白墙",
            "xwj_xwugeng_baiqian_info":"<font color=#F0F>无色界神力</font><br><li> 锁定技，游戏开始阶段，你令所有其他角色的所有技能失效，直到其受到伤害为止<br><li>出牌阶段限一次，你可以选择攻击范围内的一名其他角色，令其所有技能失效，直到其回合结束；且不能使用或打出牌，直到其回合开始<br><li>锁定技：①你使用的【杀】可指定任意名角色; ②当你的手牌数与体力值不相等时，你不能成为【杀】或锦囊牌的目标",
            ...
            "xwj_xwugeng_baiqian3_info":"当你的手牌数与体力值不相等时，你不能成为【杀】或锦囊牌的目标，你使用的【杀】可指定任意名角色",
