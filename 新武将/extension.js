...
var chat=['如是因，如是果，你们这一生对他人所做的伤害，都会一次过回到自己身上','让我代天惩罚你们……神技•因果转轮！'].randomGet();
 ...
 var chat=['尸骨脉～十指穿弹','尸骨脉～柳之舞','尸骨脉～椿之舞','尸骨脉～唐松之舞','尸骨脉～铁线花之舞','尸骨脉～八重葎之舞','尸骨脉～早蕨之舞'].randomGet();
        ...
        return event.player!=player;
                ...
                content:function (){  
         var chat=['快走开……我控制不住自己了','大蛇丸大人利用我研究出咒印之术'].randomGet();
            player.say(chat);   
    ...
    var chat=['这一天终究还是来了','就算是死，我也要回来索命'].randomGet();
      ...
      if(result.suit=='spade'){  
       ...
       player.damage('fire','nosource');              
                ...
                intro:{
                    content:"锁定技，开始阶段，若你有“炎”标记，你须进行判定，若判定结果为黑桃，你受到一点无来源的火焰伤害",
                },
            },
            "retianzhao2":{
                audio:"ext:新武将:2",
    ...
    player.$gain2(trigger.cards);
      ...
      var chat=['是神的指令杀了你','你是黑暗，在没有光明的世界中花儿只能枯萎'].randomGet();
        ...
        translate:{
            ...
            "x_kuangbao":"狂暴",
            "x_kuangbao_info":"<font color=#F0F>空气炮</font> 当一名角色受到火属性或雷属性伤害时，你可令其先受到等量的无属性伤害<font color=#F0F>配合佐助与君麻吕</font> ",
        },
    },
