	...
	"xwj_xhuoying_renzong":{
       ...
       'step 0'
            player.logSkill('xwj_xhuoying_renzong',trigger.player);                       
                trigger.player.chooseControl('xwj_xhuoying_tianyan','xwj_xhuoying_xianti').set('prompt',''+get.translation(target)+'获得一项技能');
                goon=true;                    
...
translate:{
 ...
 "xwj_xhuoying_qianshou":"千手",
            ...
            "xwj_xhuoying_renzong_info":"游戏开始时，你的体力值为无限。当一名其他角色进入濒死状态时，你可以令其选择技能【天眼】或【仙体】并永久获得之，其回复体力至2并摸两张牌，然后你失去技能【忍宗】，体力上限和体力值在你的下次行动时改为6。当该被授予忍宗的角色造成或受到一次伤害后，你随机获得两张基本牌",
			"xwj_xhuoying_tianyan":"天眼",
            "xwj_xhuoying_tianyan_info":"回合开始阶段，你可以选择一名角色，然后获得其一项技能，直到回合结束",	
			"xwj_xhuoying_liudao":"六道",
			"xwj_xhuoying_liudao_info":"锁定技，当你的体力上限为全场最高，你不能成为【杀】的目标",
