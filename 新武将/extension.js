game.import("extension",function(lib,game,ui,get,ai,_status){return {name:"新武将",content:function (config,pack){
    ...
    character:{
        character:{
            ...
            "漩涡长门":["male","shen",3,["tianyin","baoxing","lunhui","tianzheng"],["des:漩涡一族后裔，忍界大战时的孤儿，后被自来也收为徒弟，早期与弥彦等人创立晓组织，六道佩恩的实际操控者，实力恐怖。先后杀了自来也、卡卡西等人，以一己之力毁了木叶，与鸣人一战，终被鸣人说服，发动轮回天生之术令死去的木叶忍者复活后死去。后来又被兜用秽土转生之术复活，最终被宇智波鼬的十拳剑封印"]],
      ...
      trigger.finish();
       ...
       player.storage.jugong=[];
        ...
        translate:{
            ...
            lunhui:"轮回",
            "lunhui_info":"限定技，你可弃置两张[桃]并选择一名已阵亡角色，令其复活，其体力回复至X，并摸X张的牌（X为该角色的体力上限），然后你将你的武将牌翻面",
            tianyin:"天引",
...
},files:{"character":["new.jpg"],"card":[],"skill":[]}}})