...
var skill=trigger.player.skills.randomGet()
   ...
   if(player.hp>1&&player.num('h',{name:'tao'})) return 3;
        ...
        translate:{
            ...
            zongbao:"重瀑",
            "zongbao_info":"当你于回合内重复使用同名卡牌时，你摸一张牌",
            duanbi:"断臂",
            "duanbi_info":"出牌阶段，你可以流失一点体力并摸两张牌，若如此做，你无视对方的防具，并且你使用的【杀】和【决斗】造成的伤害+1",
            "duanbi2":"断臂",
            "duanbi2_info":"你无视对方防具，并且你使用的【杀】和【决斗】造成的伤害+1",
            yizhu:"易主",
            "yizhu_info":"（黑绝阴阳遁•精神附体•同化）限定技，出牌阶段，你可以弃置一张【闪电】，选择一名存活的其他非主公角色，令其回复一点体力并将武将牌换为大木筒辉夜姬，然后你回复一点体力",
            yiwu:"易物",
            "yiwu_info":"（白绝易物变化之术）出牌阶段限一次，你可以弃置一张红色手牌，选择一名存活的其他角色，令你的武将牌与技能均同化与目标角色一致，若如此做，你失去当前角色“绝”的所有技能",
            juneng:"聚能",
    ...
    version:"20171118",
},files:{"character":["huiye.jpg","kakasi.jpg"],"card":[],"skill":[]}}})