	...
	game.import('character',function(){
			var xwugeng={
				...
				character:{
					...
					"xwj_xwugeng_xuanfeng":["male","shen",3,["xinshensu","xwj_xwugeng_baofeng","xwj_xwugeng_zhengkong"],[]],
...
skill:{
	 ...
	 "xwj_xwugeng_baofeng3":{
        ...
        return get.attitude(player,event.player)>0;
         ...
         trigger.player.recover(1-trigger.player.hp);   
		 player.removeSkill('xwj_xwugeng_baofeng2');
    },
            },
 ...
 translate:{
	 "xwj_xwugeng_xuanfeng":"玄风圣王",
	  "xwj_xwugeng_baofeng3":"风",
            ...
            "xwj_xwugeng_baofeng1_info":"当你受到伤害后，你可令一名其他角色的进攻距离-X（X为其体力值）",
            "xwj_xwugeng_zhengkong2":"真空",
            "xwj_xwugeng_zhengkong2_info":"锁定技，你的回合开始起计时，九九八十一秒后，你因窒息而死亡",
            "xwj_xwugeng_baofeng":"暴风",
            "xwj_xwugeng_baofeng_info":"<li>当你受到伤害后，你可令一名其他角色的进攻距离-X（X为其体力值）<li>限定技，当一名其他角色进入濒死状态时，你可选择令其体力回复至1，并且其防御距离永久+Y（Y为其损失的体力值）",
            "xwj_xwugeng_zhengkong":"真空",
            "xwj_xwugeng_zhengkong_info":"当你一次受到大于一点的伤害后，你可选择令一名其他非主公角色在其回合开始起计时，九九八十一秒后，其因窒息而死亡",
	 "xwj_xwugeng_tian":"天",
