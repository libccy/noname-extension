        ...
        trigger.finish();
            ...
            reshenwei:{
                ...
                viewAs:{
                    ...
                    suit:"diamond",
                    number:5,
                    cards:[{"node":{"image":{},"info":{},"name":{},"name2":{},"background":{},"intro":{},"range":{}},"storage":{},"vanishtag":[],"_uncheck":[],"suit":"diamond","number":5,"name":"muniu","cardid":"9150479360","clone":{"name":"muniu","suit":"diamond","number":5,"node":{"name":{},"info":{},"intro":{},"background":{},"image":{}},"_transitionEnded":true,"fixed":true,"timeout":5417},"original":"h","cards":[{"node":{"image":{},"info":{},"name":{},"name2":{},"background":{},"intro":{},"range":{}},"storage":{},"vanishtag":[],"_uncheck":[],"suit":"club","number":3,"name":"jiu","cardid":"4847055292","clone":{"name":"jiu","suit":"club","number":3,"node":{"name":{},"info":{},"intro":{},"background":{},"image":{}},"_transitionEnded":true,"timeout":2890},"original":"h","timeout":5481}]}],
                },
                filter:function (event,player){
...
var chat=['真没劲','抱歉抱歉……'].randomGet();
    ...
    var chat=['不管你镀金还是镀银，都得剥落','告诫你：不要以貌取人'].randomGet();
        ...
        translate:{
            ...
            shanjie:"闪捷",
            "shanjie_info":"（飞雷神）锁定技，你的防御距离始终+1。回合内你使用的任何非转化卡牌无距离限制",
            luoxuan:"螺旋",
            ...
            shazang:"沙葬",
            "shazang_info":"（沙暴大葬）当你起码满足以下两个条件之一时：1、使用的牌为最后一张手牌；2、你的体力值为1。（一尾守鹤）你使用的牌可无视距离，此时你使用的【杀】【决斗】【火攻】【过河拆桥】【顺手牵羊】可指定任意名目标角色。你使用杀时若手牌数或体力值小于2，此杀可无视对方防具且不可闪避",
            juefang:"绝防",
            ...
            zhuansheng:"转生",
            "zhuansheng_info":"（秽土转生）出牌阶段限一次，你可弃置一张【桃】并选择一名已阵亡角色，令其复活，其体力回复至2，摸两张的牌，并且身份阵营与你一致（若你为主公则视阵营为忠臣），然后你失去一点体力上限（限身份局）",
            fenshen:"分身",
            ...
            bamen:"八门",
            "bamen_info":"锁定技，出牌阶段开始时，若你的体力值为4或更少，你视为拥有技能“马术”（朝孔雀）；若你的体力值为3或更少，你视为拥有技能“咆哮”（昼虎）；若你的体力值为2或更少；你视为拥有技能“伏骑”（夕象）；若你的体力值为1，你视为拥有技能“暗箭”（夜凯）",
            fuzhi:"复制",
            "fuzhi_info":"游戏开始所有角色摸牌后、准备阶段开始前和结束阶段，你可以选择一名存活角色，获得其所有技能，直到下一次更改（部分能引起冲突的技能除外）",
            resizhan:"死战",
            "resizhan_info":"（八门遁甲）限定技，出牌阶段开始前，你可以摸8张牌，然后你的体力上限调整至1",
            chendun:"尘遁",
            ...
            "zhoushu2_info":"",
            yiyuan:"遗志",
            "yiyuan_info":"限定技，觉醒技，濒死阶段，若你有手牌，你可以将所有手牌交给一名体力上限大于你的其他角色，调整你的体力上限至与该角色相同，然后回复体力至体力上限，并获得技能“轮墓”（此乃完全体须佐能乎！重生获轮回眼，遗志带土）轮墓：（轮墓边狱）你每造成1点伤害后，可以立即获得受到伤害的角色的一张牌。",
            xinxuzuo:"须佐",
            ...
            reshouhu:"守护",
            "reshouhu_info":"（守护木叶！最强幻术——别天神）限定技，出牌阶段，你可以弃置一张红色手牌，选择一名存活的非主公角色，令其身份与你一致（你不为主公限身份局），并且其之后的一切行动受你控制，然后你（止水）自杀身亡（无伤害来源）",
            linghua:"灵化",
            ...
            yuanyu:"怨虞",
            "yuanyu_info":"（地怨虞）你每杀死一名角色后，你永久获得该角色的随机一项技能，然后你依次增加一点体力上限（不得超过5）和回复一点体力",
            zhongquan:"重拳",
            ...
            newkuilei:"傀儡",
            "newkuilei_info":"每当你失去一张装备区的牌，你可以获得1名其他角色的一张手牌或判定区的牌",
            huomeng:"惑梦",
            "huomeng_info":"（伊邪那歧）结束阶段，你可以弃置一张装备区的牌，对自己施加终极幻术，然后进入伊邪那歧梦境：直到下回合开始，你防止受到非属性伤害（佐助可破之）",
            "huomeng2":"梦境",
            "huomeng2_info":"（伊邪那歧）锁定技，你防止受到非属性伤害",
            duoyang:"夺眼",
            "duoyang_info":"每当你造成伤害后，你可以选择一项：1、获得受到伤害的角色装备区里的一张牌（你的装备区相应位置不能有此类装备牌）；2、摸一张牌。",
            kongbo:"空波",
            "kongbo_info":"（风遁•真空波）锁定技，若你的装备区有牌，你无视对方的防具",
            sixiang:"四象",
            "sixiang_info":"（四象封印）当你死亡时，若伤害来源与你距离为1，你可令其失去当前的所有技能，直到游戏结束。",
            chengyi:"承艺",
            ...
            "yuedu3_info":"与其距离为1",
            baozi:"孢子",
            "baozi_info":"（孢子之术）回合外，当你需要打出一张卡牌【杀】或者【闪】时，你可以观看任意一名其他角色的手牌并将其视为你的手牌打出（白绝有柱间细胞，故类似千手柱间的技能木遁，兼有侦察能力）",
            leishu:"雷速",
            "leishu_info":"锁定技，你使用的任何卡牌无数量限制，可选择距离不大于此牌点数的目标",
            duanbi:"断臂",
            "duanbi_info":"（雷犁热刀）出牌阶段，你可以流失一点体力并摸两张牌，若如此做，你获得以下效果：1、无视对方的防具，2、你使用的【决斗】造成的伤害+1",
            "duanbi2":"断臂",
            "duanbi2_info":"（雷犁热刀）你无视对方防具，并且你使用的【决斗】造成的伤害+1",
            yiwu:"易物",
            "yiwu_info":"（白绝易物变化之术）限定技，出牌阶段，你可以弃置一张【无懈可击】，选择一名存活的其他角色，令你的武将牌与技能均同化与目标角色一致，若如此做，你摸两张牌并先失去发动此技能前的角色“绝”的所有技能",
            juneng:"聚能",
            ...
            zhongbao:"重瀑",
            "zhongbao_info":"（雷我暴弹）当你于回合内重复使用同名卡牌时，你摸一张牌",
            xinzhenjun:"镇军",
            ...
            tianyu:"天御",
            "tianyu_info":"（天之御中、黄泉比良坂）出牌阶段限一次，若存活人数大于2，你可以令所有其他角色与随机角色交换位置",
            baodun:"爆遁",
            ...
            huigu:"灰骨",
            "huigu_info":"（白眼、轮回写轮眼、共杀灰骨）出牌阶段限一次，你可以令攻击范围内的一名有手牌的其他角色展示一下其手牌，该角色陷入瞳术中，获得以下效果：直到回合结束，其不能使用或打出牌。然后你须弃置其一张牌",
            feiniao:"飞鸟",
            ...
            "jiuwei_info":"当场上有其他角色使用【桃】时，你可以弃掉【九尾】，阻止【桃】的结算并将其收为手牌",
            shayu:"砂雨",
            "shayu_info":"（砂铁时雨）当你失去一张装备区的牌后，你可以选择一项：1、摸一张牌；2、弃置一名其他角色的一张牌",
            xfeixian:"飞翔",
    ...
    version:"20171118",
},files:{"character":["gangshou.jpg","dashewan.jpg","zhishui.jpg","dayemu.jpg","kai.jpg","jiangboyue.jpg","liluoke.jpg","tuanzang.jpg","itachi.jpg","dou.jpg","sanlei.jpg","duan.jpg","wuren.jpg","zaibuzhan.jpg","xiaoyaozi.jpg","jinye.jpg","relingju.jpg","xiaoying.jpg","kanjiulang.jpg","xuSukincen.jpg","didala.jpg","chutian.jpg","xiezi.jpg","luwan.jpg","leiying.jpg","huiye.jpg","genie.jpg","weizhuang.jpg","feiduan.jpg","ban.jpg","daitu.jpg","guijiao.jpg","feijian.jpg","zhuozhu.jpg","mingren.jpg","woailuo.jpg","rewangyun.jpg","jiaodu.jpg","dingchi.jpg","xinyujins.jpg","jue.jpg","daluyi.jpg","zhilaiye.jpg","kakasi.jpg","changmen.jpg","shuimen.jpg","xinmenghuo.jpg","zhujian.jpg","ningchi.jpg","zhizhangfei.jpg"],"card":["jiuwei.png"],"skill":[]}}})