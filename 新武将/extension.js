...
content:function (){
 ...
 translate:{
	 ...
	 "xwj_xwugeng_baiqian":"白墙",
            ...
            "xwj_xwugeng_fuchou_info":"<li><font color=#F0F>修罗界神力</font>锁定技，你的进攻距离+X，摸牌阶段摸牌时，你额外摸X张牌（X为你损失的体力值）；<br><li><font color=#F0F>元始界神力</font>你使用的【杀】额外造成Y点的伤害（Y为你的损失的体力值的一半进位取整）",
            "xwj_xwugeng_fuchou2":"复仇",
            "xwj_xwugeng_fuchou2_info":"锁定技，你使用的【杀】额外造成Y点伤害（Y为你的损失的体力值的一半进位取整）",
