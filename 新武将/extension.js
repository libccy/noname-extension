...
content:function (config,pack){
    ...
    character:{
        character:{
            ...
            huiye:["female","shen",3,["juneng","tianyu"],[]],
        },
        translate:{
            itachi:"宇智波鼬",
            genie:"盖聂",
    ...
    var chat=['影子模仿术，成功得手','真麻烦！'].randomGet();
        ...
        return get.type(card)=='basic';
                ...
                viewAs:{
                    ...
                    suit:"heart",
                    number:4,
                    cards:[{"node":{"image":{},"info":{},"name":{},"name2":{},"background":{},"intro":{},"range":{}},"storage":{},"vanishtag":[],"_uncheck":[],"suit":"heart","number":4,"name":"tao","cardid":"9146499325","clone":{"name":"tao","suit":"heart","number":4,"node":{"name":{},"info":{},"intro":{},"background":{},"image":{}},"_transitionEnded":true,"timeout":2002},"timeout":1980,"original":"h"}],
                },
                viewAsFilter:function (player){
   ...
   if(player.hp>1&&player.num('h',{name:'tao'})) return 3;
        ...
        player.draw(2);     
            ...
            juneng:{
                ...
                usable:1,
                filterTarget:function (card,player,target){
        return target.hp==target.maxHp||target.hp>=player.hp;
    },
                content:function (){
        'step 0'
        target.damage(true);
        ...
        if(player.hp<player.maxHp){
            player.recover();
                ...
                ai:{
                    ...
                    result:{
                        target:function (player,target){
                if(target.hp==target.maxHp||target.hp>=player.hp) return 0.5;              
                return 0;
            },
                    },
                },
        ...
        translate:{
            ...
            duanbi:"断臂",
            "duanbi_info":"出牌阶段，你可以流失一点体力并摸两张牌，若如此做，你无视对方的防具，并且你使用的【杀】和【决斗】造成的伤害+1",
            "duanbi2":"断臂",
            "duanbi2_info":"你无视对方防具，并且你使用的【杀】和【决斗】造成的伤害+1",
            yiwu:"易物",
            "yiwu_info":"（白绝易物变化之术）限定技，出牌阶段，你可以弃置一张红色手牌，选择一名存活的其他角色，令你的武将牌与技能均同化与目标角色一致，若如此做，你摸两张牌并先失去发动此技能前的角色“绝”的所有技能",
            juneng:"聚能",
            "juneng_info":"（回收查克拉）出牌阶段限一次，你可以令一名未受伤或体力不小于你的其他角色受到一点伤害，若你已受伤，你回复一点体力",
            yinmou:"阴谋",
            "yinmou_info":"（黑绝阴阳遁•精神附体•同化，谋划复活母亲辉夜姬）限定技，出牌阶段，你可以弃置一张【闪电】，选择一名存活的其他角色，令其将武将牌更换为大木筒辉夜姬，然后你与其各回复一点体力",
            zhongbao:"重瀑",
            "zhongbao_info":"当你于回合内重复使用同名卡牌时，你摸一张牌",
        },
    },
    ...
    version:"20171118",
},files:{"character":["huiye.jpg"],"card":[],"skill":[]}}})