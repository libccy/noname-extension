game.import("extension",function(lib,game,ui,get,ai,_status){return {name:"新武将",editable:false,content:function (config,pack){
    ...
    character:{
        character:{
            ...
            leiying:["male","shen",4,["duanbi","leishu","zhongbao"],["des:艾，日本动漫《火影忍者》中雷之国云隐村的四代目雷影，八尾人柱力奇拉比的义兄[1]。 性格暴躁冲动，身体健壮并以速度著称，全身在“雷遁护体”的保护下，速度和防御力都堪称强劲，在第四次忍界大战中担任忍者联军的统帅，后来在第四部队战场中与其余四影大战宇智波斑，结果被斑击败，恢复伤势后前往十尾战场支援前线，与其余联军合力击败十尾。"]],
    ...
    event.finish();
        ...
        player.recover();
            ...
            shunsheng:{
                ...
                changeSeat:true,
                filterTarget:function (card,player,target){
        return player!=target&&player.countCards('h',{color:'black'})>0;
    },
                filterCard:{
                    color:"black",
                },
...
player.revive(player.maxHp)
   ...
   "step 2"
    ...
    player.$gain2(trigger.cards);
      ...
      var chat=['是神的指令杀了你','你是黑暗，在没有光明的世界中花儿只能枯萎'].randomGet();
        ...
        translate:{
            ...
            fenshen:"分身",
            "fenshen_info":"<font color=#F0F>影分身之术</font> 出牌阶段限一次，你可以用一张手牌与任意名角色同时拼点，然后依次结算拼点结果，若你赢，没赢的角色随机弃置一张牌；若你拼点没赢，你摸一张牌，并获得一个“分身”标记（若你有9个或以上的分身标记时，你因耗尽九尾的查克拉而立即死亡）",
            xianyan:"献眼",
            ...
            shunsheng:"瞬身",
            "shunsheng_info":"<font color=#F0F>瞬身止水</font> 出牌阶段限一次，你可以弃置一张黑色手牌，和一名存活的角色交换位置。",
            "renfa3":"忍法",
    ...
    version:"20180423",
},files:{"character":["x_dahe.jpg"],"card":["x_houzi.png"],"skill":[]}}})