game.import("extension",function(lib,game,ui,get,ai,_status){return {name:"新武将",editable:false,content:function (config,pack){
    ...
    character:{
        character:{
            ...
            "x_xiaonan":["female","shen",4,["x_jizhu"],["des:小南，日本动漫《火影忍者》中的人物。“晓”组织的创立者之一，而且是其中唯一一个女性成员，代号“白”（白虎），被称为“天使”。她是第二次忍界大战时雨隐村的孤儿，曾经和弥彦、长门一起接受过自来也的忍术指导。后来和长门一起被漩涡鸣人的真诚所感动，重拾保护世界和平的信心。曾设计六千亿张起爆符诛杀宇智波带土，但失败。最终为了保护长门的遗体的轮回眼而被自称为“宇智波斑”的“面具男”（宇智波带土）杀死。"]],
        },
        translate:{
            itachi:"宇智波鼬",
            genie:"盖聂",
...
player.revive(player.maxHp)
       ...
       player.damage('fire','nosource');              
        ...
        return player.countCards('h','sha')>0;
            ...
            baoxing:{
                ...
                viewAs:{
                    name:"nanman",
                    cards:[{"node":{"image":{},"info":{},"name":{},"name2":{},"background":{},"intro":{},"range":{}},"storage":{},"vanishtag":[],"_uncheck":[],"suit":"heart","number":4,"name":"sha","nature":"fire","cardid":"5504703355","original":"h","_transform":"translateX(336px)","clone":{"name":"sha","suit":"heart","number":4,"node":{"name":{},"info":{},"intro":{},"background":{},"image":{}},"_transitionEnded":true,"timeout":4933},"timeout":4837},{"node":{"image":{},"info":{},"name":{},"name2":{},"background":{},"intro":{},"range":{}},"storage":{},"vanishtag":[],"_uncheck":[],"suit":"heart","number":10,"name":"sha","cardid":"3945222398","_transform":"translateX(448px)","clone":{"name":"sha","suit":"heart","number":10,"node":{"name":{},"info":{},"intro":{},"background":{},"image":{}},"_transitionEnded":true,"timeout":4934},"timeout":4838,"original":"h"}],
                },
   ...
   "step 2"
    ...
    player.$gain2(trigger.cards);
        ...
        "step 1"
        if(!event.num) event.num=player.num('h')+player.maxHp-player.hp;
        ...
        translate:{
            ...
            baoxing:"爆星",
            "baoxing_info":"出牌阶段限一次，你可以将任意两张相同花色的手牌当【南蛮入侵】使用。",
            xtishen:"替身",
            ...
            "x_jizhu":"计诛",
            "x_jizhu_info":"当你受到伤害后，你可以依次弃置任意名角色的共计X张牌。（X为你的手牌数与损失的体力值之和） ",
        },
    },
    ...
    version:"20180423",
},files:{"character":["x_xiaonan.jpg"],"card":["x_houzi.png"],"skill":[]}}})