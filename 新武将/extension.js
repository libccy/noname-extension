game.import("extension",function(lib,game,ui,get,ai,_status){return {name:"新武将",editable:false,content:function (config,pack){
    ...
    character:{
        character:{
            ...
            "x_junmalei":["male","shen",3,["x_gu","x_zhouyin"],["des:君麻吕，日本动漫《火影忍者》中的人物。辉夜一族（又译竹取一族）血继限界“尸骨脉”的持有者，被大蛇丸看中，一心为大蛇丸效命，对大蛇丸忠心耿耿，是音忍五人众中最强的一人。 体术高超，具有超强的实力，但后因患了重病，在与我爱罗的交战中病发而亡。第四次忍者大战被药师兜以秽土转生形式复活，后被宇智波鼬解除秽土转生，灵魂升天。"]],
        },
        translate:{
            itachi:"宇智波鼬",
            genie:"盖聂",
    ...
    card:{
        ...
        list:[["heart","9","jiuwei"],["club","3","xuelunyan"]],
    },
    skill:{
        skill:{
            "蛮王":{
        ...
        return player.countCards('h','sha')>0
                ...
                viewAs:{
                    ...
                    suit:"spade",
                    number:9,
                    cards:[{"node":{"image":{},"info":{},"name":{},"name2":{},"background":{},"intro":{},"range":{}},"storage":{},"vanishtag":[],"_uncheck":[],"suit":"spade","number":9,"name":"sha","cardid":"4506969331","clone":{"name":"sha","suit":"spade","number":9,"node":{"name":{},"info":{},"intro":{},"background":{},"image":{}},"_transitionEnded":true,"timeout":1844},"timeout":1825,"original":"h"}],
                },
...
var chat=['如是因，如是果，你们这一生对他人所做的伤害，都会一次过回到自己身上','让我代天惩罚你们……神技•因果转轮！'].randomGet();
 ...
 var chat=['尸骨脉～十指穿弹','尸骨脉～柳之舞','尸骨脉～椿之舞','尸骨脉～唐松之舞','尸骨脉～铁线花之舞','尸骨脉～八重葎之舞','尸骨脉～早蕨之舞'].randomGet();
        ...
        translate:{
            ...
            zhongbao:"重瀑",
            "zhongbao_info":"<font color=#F0F>雷我暴弹</font> 当你于回合内重复使用同名卡牌时，你摸一张牌",
            xinzhenjun:"镇军",
            ...
            "极道":"极道",
            "极道_info":"出牌阶段限1次，你可以弃置所有手牌，并将自己翻面，指定一个目标，从你开始场上所有角色依次与其进行决斗，直到其体力值为1。",
            "x_xiemu":"协穆",
            "x_xiemu_info":"每当你成为其他角色的黑色牌的目标，可以弃置一张杀并摸两张牌",
            "x_naman":"纳蛮",
            "x_naman_info":"你可以获得其他角色打出的杀",
            "x_gu":"骨舞",
            "x_gu_info":"<font color=#F0F>尸骨脉</font> 出牌阶段限一次，你可将所有手牌发动以下效果：所有其他角色须打出两张【闪】响应，否则其受到一点属性伤害，且随机弃置一张牌",
            "x_zhouyin":"咒印",
            "x_zhouyin_info":"<font color=#F0F>地之咒印</font> 当其他角色出牌阶段开始时，若其手牌数大于你的手牌数，你可以摸一张牌",
        },
    },
    ...
    version:"20171118",
},files:{"character":["x_junmalei.jpg"],"card":["xuelunyan.png"],"skill":[]}}})