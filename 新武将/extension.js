game.import("extension",function(lib,game,ui,get,ai,_status){return {name:"新武将",editable:false,content:function (config,pack){
    ...
    card:{
        ...
        translate:{
            weishou:"九尾",
            "weishou_info":"当场上有其他角色使用【桃】时，你可以弃掉【九尾】，阻止【桃】的结算并将其收为手牌（宠物牌，收拾查克拉）",
        },
        list:[["heart","9","weishou"]],
    },
    skill:{
        skill:{
            "蛮王":{
     ...
     player.loseHp();
        ...
        if(player.hp<=0){
            ...
            zhenxing:{
                ...
                viewAs:{
                    name:"wanjian",
                    cards:[{"node":{"image":{},"info":{},"name":{},"name2":{},"background":{},"intro":{},"range":{}},"storage":{},"vanishtag":[],"_uncheck":[],"suit":"club","number":7,"name":"sha","cardid":"9220450264","original":"h","clone":{"name":"sha","suit":"club","number":7,"node":{"name":{},"info":{},"intro":{},"background":{},"image":{}},"_transitionEnded":true,"timeout":3778},"timeout":3761},{"node":{"image":{},"info":{},"name":{},"name2":{},"background":{},"intro":{},"range":{}},"storage":{},"vanishtag":[],"_uncheck":[],"suit":"spade","number":10,"name":"sha","cardid":"2723818356","clone":{"name":"sha","suit":"spade","number":10,"node":{"name":{},"info":{},"intro":{},"background":{},"image":{}},"fixed":true,"timeout":3423},"original":"h","_transform":"translateX(0px)"}],
                },
                filterCard:{
                    name:"sha",
                },
   ...
   if(player.hp>1&&player.num('h',{name:'tao'})) return 3;
    ...
    player.recover();
            ...
            yinmou:{
                ...
                enable:"phaseUse",
                skillAnimation:true,
                animationStr:"阴阳遁•精神附体",
                animationColor:"fire",
                filterTarget:function (card,player,target){
        return player!=target&&player.countCards('h',{name:'shandian'});
    },
                filterCard:{
                    name:"shandian",
                },
...
var chat=['只有瞬间的绚丽，才是艺术','这个艺术，终会得到世人的赞美'].randomGet();
        ...
        if(card){
            var name=card.name;              
            if(event.name=='tao'&&get.itemtype(event.cards)=='cards'&&get.position(event.cards[0])=='d'&&event.player!=player&&name&&name.indexOf('weishou')!=-1) return true;
        }
        return false;
    },
                check:function (event,player){
   ...
   "step 2"
    ...
    player.$gain2(trigger.cards);
        ...
        translate:{
            ...
            changsheng:"永生",
            "changsheng_info":"濒死阶段，你可摸一张牌，你可以与一名有手牌的其他角色拼点，若你赢，你与该角色交换体力值（伤害来源转为你）并且你增加一点体力上限；若你拼点没赢，你回复体力至体力上限并摸一张牌，然后你失去一点体力上限并翻面",
            rechendun:"尘遁",
            ...
            yiwu:"易物",
            "yiwu_info":"（白绝易物变化之术）限定技，出牌阶段，你可以弃置一张红色手牌，选择一名存活的其他角色，令你的武将牌与技能均同化与目标角色一致，若如此做，你摸两张牌并先失去发动此技能前的角色“绝”的所有技能",
            juneng:"聚能",
            "juneng_info":"（查克拉之祖）锁定技，每名角色的回合限一次：当一名角色受到伤害，你摸一张牌；当一名角色回复一点体力，若你已受伤，你回复一点体力",
            yinmou:"阴谋",
            "yinmou_info":"（黑绝阴阳遁•精神附体•同化，谋划复活母亲辉夜姬）限定技，出牌阶段，你可以弃置一张【闪电】，选择一名存活的其他角色，令其将武将牌更换为大木筒辉夜姬，然后你与其各回复一点体力",
            zhongbao:"重瀑",
            ...
            weishou:"九尾",
            "weishou_info":"当场上有其他角色使用【桃】时，你可以弃掉【九尾】，阻止【桃】的结算并将其收为手牌",
            lunxue:"轮写",
    ...
    version:"20171118",
},files:{"character":["gangshou.jpg","ban.jpg","dayemu.jpg","dou.jpg","woailuo.jpg","itachi.jpg","dashewan.jpg","zhilaiye.jpg","zhishui.jpg","ningchi.jpg","kai.jpg","chutian.jpg","daitu.jpg","jiangboyue.jpg","changmen.jpg","sanlei.jpg","duan.jpg","wuren.jpg","xiezi.jpg","relingju.jpg","feijian.jpg","zaibuzhan.jpg","dingchi.jpg","xiaoyaozi.jpg","kanjiulang.jpg","jiaodu.jpg","leiying.jpg","xinyujins.jpg","liluoke.jpg","guijiao.jpg","rewangyun.jpg","luwan.jpg","jinye.jpg","jue.jpg","zhujian.jpg","didala.jpg","xuSukincen.jpg","weizhuang.jpg","feiduan.jpg","zhuozhu.jpg","shuimen.jpg","xinmenghuo.jpg","tuanzang.jpg","huiye.jpg","mingren.jpg","xiaoying.jpg","genie.jpg","kakasi.jpg","zhizhangfei.jpg"],"card":["weishou.png"],"skill":[]}}})