game.import("extension",function(lib,game,ui,get,ai,_status){return {name:"新武将",editable:false,content:function (config,pack){
...
},help:{"新武将":"<li>重铸部分三国杀武将。<li>《火影忍者》、《秦时明月》、《武庚纪》人物乱入无名杀，与三国群雄逐鹿中原！<li>游戏时若遇见卡死情况，打开兼容模式提高扩展的兼容性即可解决。<li>【编码】Sukincen<li>【配图】Sukincen<li>【录制配音】Sukincen"},config:{"sanguo":{"name":"三国新将","init":true},"huoying":{"name":"火影忍者","init":true},"qinshi":{"name":"秦时明月","init":true},"wugengji":{"name":"武庚纪","init":true},"NO1":{"name":"注：以上四个选项开关是无效的","item":{}}},package:{
    character:{
        character:{
            ...
            zhujian:["male","shen",3,["mudun","qianshou","xianti"],["forbidai","des:初代目火影——千手柱间，战乱时代中千手一族的首领，木叶村的建立者之一，二代火影千手扉间的兄长，六道仙人大筒木羽衣次子阿修罗上一代转世者 。擅长使用“木遁”，能瞬间使出仙术，其身体能量和回复力极其惊人，具有操控尾兽的能力；平定乱世，平均分配尾兽给五大国，并在终结之谷之战中一举击败宇智波斑，是宇智波斑唯一敬畏的忍者。因此凡见过其风采的人皆称其是“如同六道仙人一般的神话”，被忍界誉为“忍者之神”。在第四次忍界大战中一度被大蛇丸以秽土转生的形式复活，与同被复活的历代火影一起前往战场支援忍者联军。"]],
            ...
            ban:["male","shen",2,["zhenxing","xinxuzuo","yiyuan"],["des:宇智波一族前任首领，宇智波佐助前一任的六道仙人长子因陀罗转世者。宇智波一族最强的男人，擅长使用“须佐能乎”以及可以和尾兽匹敌的“完成体须佐能乎”，被世人将其和千手柱间合称为“传说中的忍者”。 曾和千手柱间合作建立了第一个忍村，并将其命名为“木叶”。在黑绝的蛊惑下与千手柱间在终结之谷交战，败在柱间手下，普遍被世人认为已死亡，事实上在右眼植入了伊邪那岐，存活了下来并获得了柱间细胞。利用柱间细胞在死前开启轮回眼，通灵出外道魔像和上一次无限月读开启后产生的白绝，将轮回眼移植于长门身上。第三次忍界大战时期，在神无毗桥之战中救下宇智波带土，计划复活后进行月之眼计划。 第四次忍界大战时期被药师兜用秽土转生之术召唤。后利用带土施展外道·轮回天生之术成功复活，在吸收了再次复活的十尾后成为了十尾人柱力，发动无限月读后遭到黑绝背叛。大筒木辉夜被封印后由于体内尾兽被剥离即将死去，奄奄一息的他在和柱间敞开心扉后微笑地走向了人生真正的终点。"]],
            dayemu:["male","shen",3,["chendun","tiancheng","xfeixian"],["des:大野木，外号“两天秤”，三代目土影。虽然是一个矮小的老头，却拥有无比恐怖强大的忍术，比血界限界更高层次的血界淘汰——尘遁•原界剥离之术，此术发动简单迅速，但威力巨大得令人咋舌，能瞬间将一切物质分离成分子状态，无法复原，任何人一旦中招，瞬间灰飞烟灭。超轻岩之术令他能减轻物体重量甚至自身重量，在空中自由飞行，超重岩之术又能增加破坏力和接触到的物体包括人的压力，令其不能动弹或碎裂，两天秤称号由此而来。。。"]],
            ...
            mingren:["male","shen",3,["fenshen","xianshu"],["des:漩涡鸣人，《火影忍者》系列的主角。火之国木叶忍村的忍者，四代目火影波风水门和漩涡玖辛奈之子，六道仙人次子阿修罗转世。刚出生时父母为保护村子而牺牲，并将强大的尾兽“九尾”封印于鸣人体内。成为孤儿的鸣人在孤独中长大，但在唯一认同他的老师海野伊鲁卡以及三代目火影鼓励下逐渐决心要成为火影，让所有人都认同他的存在。成为忍者后，同旗木卡卡西、宇智波佐助和春野樱组成第七班进行各种任务。 为实现理想，和守护伙伴们的羁绊，鸣人不断修炼，作为木叶“三忍”之一自来也的弟子，学会了父亲的忍术螺旋丸，后将之升级，加入风遁属性，练成威力强大的风遁手里剑，曾以此秒杀晓组织的高手角都；又练就仙术打败佩恩六道，拯救木叶；后又在众人帮助下练成“九尾模式”，移动速度惊人，尤如“金色闪光”再世，后先后与秽土转生的众高手、六道宇智波带土、六道宇智波斑、大筒木辉夜战斗，最后与包括九尾在内的伙伴们一同终结了战争，与佐助决斗，最终感化了佐助，为纷争不断的忍者世界带来和平，并实现自己成为火影和忍界英雄的梦想"]],
            ...
            wuren:["male","shen",3,["rechendun","xfenlie","wuchen"],["des:无，日本动漫《火影忍者》中的人物。土之国岩隐村的第二代土影，以阴谋和政治而闻名的“智将”，拥有令人无法感知查克拉的恐怖隐身能力——无尘迷塞，和超越于血继限界的血继淘汰——尘遁，并将其传授给徒弟第三代土影大野木，生前与二代水影同归于尽。死后被药师兜秽土转生，被迫参加第四次忍界大战，最终宇智波鼬解开了秽土转生，灵魂升天。"]],
            ...
            liluoke:["male","shen",3,["relianhua","rexuanfeng"],["des:日本动漫《火影忍者》中的人物，也是《李洛克的青春全力忍传》的男主角。火之国木叶忍者村的忍者，自号“木叶美丽的苍蓝野兽”。小李是个“笨鸟先飞”型的热血少年，单纯而又热血，一心想成为一名优秀的忍者，并一直为此努力奋斗。他不会忍术和幻术，也没有与生俱来的特殊技能，但他有坚韧不拔的精神，面对困难从不畏惧。他起早贪黑，付出了比别人多几十倍的努力，纵然一次次失败，却始终坚信只要足够努力，照样可以成为优秀的忍者。"]],
            ...
            feijian:["male","shen",3,["jinshu","baofu","shuidun"],["des:千手扉间，日本动漫《火影忍者》中的人物，火之国木叶村的第二代火影，是初代火影手手柱间的弟弟、木叶村的建立者之一，对村子的兴旺发达做出了杰出的贡献。扉间擅长水遁系忍术，能在干旱无水的地方发动大规模的水遁。同时善于研究开发忍术，开发了飞雷神之术、影分身之术及禁术秽土转生，声名显赫。在第一次忍界大战中和第二代雷影被金角银角暗算而阵亡。在第四次忍界大战中被大蛇丸秽土转生，前往战场支援忍者联军，将接受六道仙人馈赠的宇智波佐助送往战场，之后无限月读开启，扉间和其他三位被转生的火影并没有受到影响，并与他们一起赶赴战场。大筒木辉夜被封印以后，由六道仙人解除秽土转生，灵魂与其他先代影们一同回归净土。"]],
            ...
            xuSukincen:["male","shen",3,["xuqingshang","xuxibie"],["des:原武将和技能设计均源于橙续缘的作品《吧友列传》扩展中的人物，为吧友即本扩展的作者Sukincen所设计的形象。原技能名分别为“探索”和“拷贝”，技能配音音效为本人所翻唱音乐作品的片段。小苏与Sukincen皆为化名，其实本人不姓苏。"]],
            zhizhangfei:["male","shu",4,["paoxiao","xtishen","探囊"],["des:糅合太阳神三国杀智包的张飞。"]],
            kanjiulang:["male","shen",3,["newkuilei","chengyi"],["des:勘九郎，日本忍者题材漫画《火影忍者》中的男性角色。风之国·砂隐村第四代风影罗砂之子，手鞠的弟弟，我爱罗的哥哥。他是一名傀儡师，特征是身穿黑色连身装以及涂绘在脸上的紫色状纹，且每次现身总有新的傀儡术。 既爱好策略，也有冲动的一面。原本与手鞠一样对强大而残暴的弟弟有所畏惧，后来随着我爱罗性情的改变，勘九郎也努力和弟弟搞好关系，兄弟之情渐渐显示出来。在五影会谈中，勘九郎和手鞠一起担任我爱罗的护卫。第四次忍界大战中，勘九郎作为奇袭部队的队长。最终话的新五影会谈中，担任我爱罗的护卫。"]],
            tuanzang:["male","shen",3,["huomeng","duoyang","kongbo","sixiang"],["des:日本动漫《火影忍者》中的人物。火之国木叶村的忍者，木叶暗部的地下组织\"根\"的领导者，是第二代火影千手扉间的弟子和第三代火影猿飞日斩的竞争对手。十分不信任宇智波一族，是下令对宇智波一族实施灭族政策的木叶高层之一。同时也是一个老谋深算的家伙，不惜一切手段都要当上火影，目的是干出一番大事业，用强硬的手段守护木叶，并像千手柱间那样统一忍者世界。最终在与宇智波佐助的战斗中被佐助击败，为了死守止水之眼，用里四象封印术自尽而亡。是为木叶繁荣奉献一生的反英雄式人物。"]],
            jue:["male","shen",3,["baozi","yiwu","yinmou"],["des:绝，日本漫画《火影忍者》及其衍生作品的虚拟角色，晓成员之一，代号玄（玄武），晓中的侦查员。白绝原本是人类，表面是由宇智波斑用初代细胞创造出来的人造人，实际上与此毫无关联，是上古时代沉浸于无限月读的人类堕落后的产物。白绝本体与黑绝融合成为晓组织的“绝”，但白绝还有众多分身，一般战斗力不高，只能用于侦查，但也有像飞那种战斗力极高的存在。黑白绝分裂后，白绝本体受“宇智波斑”（宇智波带土）的命令看守移植鼬写轮眼的佐助，但是佐助开启永恒万花筒写轮眼后，为了试验瞳力，用天照将白绝本体杀死。带土曾培育出十万白绝用于第四次忍界大战，但所有分身最终死亡，其余的绝在无限月读解开之后也全部死亡。 黑绝是传说女神辉夜姬的意志产物，为了复活母亲大筒木辉夜，煽动宇智波斑与千手柱间决战，协助斑利用含在嘴中的柱间细胞开启轮回眼，修改了六道仙人南贺神社留下的信息，将拯救宇智波一族的方法引向无限月读。斑却以为黑绝是自己的意志。黑绝在第四次忍界大战中利用药师兜、宇智波带土、宇智波斑，成功完成了复活辉夜姬的使命，但最终连同辉夜姬一同被原木叶第七班封印。"]],
            huiye:["female","shen",3,["tianyu","huigu","juneng"],["des:大筒木辉夜，日本动漫《火影忍者》中的人物，本作最终BOSS。神树化身，十尾的真面目，忍界创世之神，查克拉之祖，同时拥有白眼、轮回眼、写轮眼三大瞳术。擅长使用“血继网罗”和能瞬间改变周围环境的“天之御中”。 随着时间的流逝，她的血缘又分化为宇智波、千手、漩涡、日向等家族。她的长子是忍界始祖“六道仙人”大筒木羽衣，次子是大筒木羽村。六道仙人两兄弟一同封印自己的母亲和十尾，但他们都不知道的是，她在被封印之前用意志创造了黑绝，并计划利用黑绝复活自己。 在第四次忍界大战中，黑绝成功利用宇智波斑的身体将辉夜复活。但最终辉夜还是被第七班和宇智波带土联手击败，并连同黑绝一起被再次封印。"]],
            xinyujins:["male","wei",4,["xinzhenjun"],["des:代码来源于贴吧和QQ群的大佬之手，此扩展代为收集。"]],
            didala:["male","shen",3,["baodun","zibao","feiniao"],["des:迪达拉，日本动漫《火影忍者》中的男性角色。“晓”成员之一，代号青（青龙）。土之国·岩隐村第三代土影大野木的徒弟，黑土的师兄。少年时期为了证明自己的艺术，而接受了众多的恐怖袭击任务，因败于宇智波鼬而加入“晓”组织。最终在与宇智波佐助的对决中自爆身亡。后来被药师兜用秽土转生复活，期间固执不已，与自己的师傅和师妹相见。最后在秽土转生解除后，灵魂升天。"]],
            daluyi:["male","shen",4,["x_landun","x_bizhu"],["des:达鲁伊，日本动漫《火影忍者》中的男性角色。雷之国·云隐村的上忍，四代目雷影的护卫。三代目雷影黑色雷遁的唯一继承者，拥有血继限界“岚遁”[1]。对四代目雷影极忠心，曾被四代目雷影说为是自己的“第二只右手”。在忍界大战中担任第一部队队长（中距离联合军分队），作战英勇。忍界大战结束后若干年，达鲁伊成为五代目雷影。"]],
            "x_huanyue":["male","shen",3,["x_chunshu","x_zhengbao"],["des:鬼灯幻月是日本动漫《火影忍者》中的角色。水之国雾隐村的二代目水影，生前与二代目土影无同归于尽。第四次忍界大战中被药师兜秽土转生，被我爱罗击败后封印。绝招：无限水蒸汽爆炸的“蒸危爆威”、通灵蜃发动大面积幻术、从手指射出能射穿硬物的高强度水珠——“水铁炮之术”"]],
            "x_zhengshan":["male","shen",3,["x_zhuanlun","x_chenjie","x_kongjing","x_zhuzhan"],["des:港漫《封神纪》五圣王之一，主长生界神力"]],
            "x_junmalv":["male","shen",3,["x_gu","x_zhouyin"],["des:君麻吕，日本动漫《火影忍者》中的人物。辉夜一族（又译竹取一族）血继限界“尸骨脉”的持有者，被大蛇丸看中，一心为大蛇丸效命，对大蛇丸忠心耿耿，是音忍五人众中最强的一人。 体术高超，具有超强的实力，但后因患了重病，在与我爱罗的交战中病发而亡。第四次忍者大战被药师兜以秽土转生形式复活，后被宇智波鼬解除秽土转生，灵魂升天。"]],
            "x_qilabi":["male","shen",4,["shuochang","x_leidao"],["des:日本动漫《火影忍者》中的人物角色，四代目雷影的搭档与义弟，同时也是八尾人柱力。可以完全控制八尾，实力极其强悍，喜爱说唱，喜欢玩耍，教会了九尾人柱力漩涡鸣人如何控制尾兽的方法，同时在第四次忍界大战中和鸣人一起并肩作战。"]],
            "x_yuanfeirizhan":["male","shen",3,["x_huizhan","x_yuanmo","x_fengyin"],["des:日本动漫《火影忍者》中的角色。火之国木叶忍者村的三代目火影，亦是初代火影和二代目火影的亲传弟子，培育出了威震忍界的“三忍”。精通五种查克拉属性的忍术，享有“忍术教授”的称号。同时也是木叶在任时间最久的火影，期间开创了木叶隐村的全盛时期。在大蛇丸毁灭木叶行动中因使用尸鬼封尽而牺牲，在第四次忍界大战中与其他三位火影被大蛇丸使用秽土转生之术复活并加入战斗。之后宇智波斑开启无限月读，但日斩和其他三位火影却并没有受到影响并继续战斗，之后由六道仙人解除秽土转生，灵魂回归净土。"]],
            "x_shixing":["male","shen",3,["x_fuhuo","x_fuchou"],["des:《封神纪》（动画《武庚纪》）中的人物，天之子，六部大神之一，主修罗界神力，后得到不死鸟的帮助使用元始界神力"]],
            "x_xiaonan":["female","shen",3,["x_jizhu","x_zhishu"],["des:小南，日本动漫《火影忍者》中的人物。“晓”组织的创立者之一，而且是其中唯一一个女性成员，代号“白”（白虎），被称为“天使”。她是第二次忍界大战时雨隐村的孤儿，曾经和弥彦、长门一起接受过自来也的忍术指导。后来和长门一起被漩涡鸣人的真诚所感动，重拾保护世界和平的信心。曾设计六千亿张起爆符诛杀宇智波带土，但失败。最终为了保护长门的遗体的轮回眼而被自称为“宇智波斑”的“面具男”（宇智波带土）杀死。"]],
            "x_zhongwu":["male","shen",3,["x_xianhua","x_kuangbao"],["des:重吾是日本漫画《火影忍者》中的人物，鹰小队成员之一，能够听懂动物的语言。具有双重人格，平时比较老实，暴躁时会有强烈的杀人倾向，是个被村里人成为“天秤”的男人   。 他是咒印的来源者，天生拥有能吸取自然能量的能力（即仙人化），一旦停留在自然能量超强的地方就会仙人化，但会因为无法控制而暴走。重吾的仙人化后来被大蛇丸研究，复制成咒印化。"]],
            "x_dahe":["male","shen",3,["xmudun","x_duizhang","xdaiban"],["des:日本动漫《火影忍者》中角色，原名天藏。火影直属暗部精英，从第三代火影时期起就被誉为暗部中的顶尖优秀忍者。幼年时期体内因被植入初代火影千手柱间细胞而继承了初代的木遁血继限界。风影夺还战之后，以“大和”作为任务代号，代替受伤的前辈旗木卡卡西带领第七班执行任务，在各项任务中发挥着重要作用。"]],
            "x_asima":["male","shen",4,["x_fengdun","x_shouyu","x_jinshao"],["des:阿斯玛，日本动漫《火影忍者》中的人物，是一个性格随和的正派角色。猿飞阿斯玛在火之国木叶忍者村，拥有罕见的风属性查克拉，是近战中首屈一指的上忍。 同时他也是第三代火影猿飞日斩的儿子，猿飞木叶丸的叔叔，第十班（奈良鹿丸、山中井野、秋道丁次）的老师，上忍夕日红的情侣。后来在与“晓”的战斗中被飞段杀死，临终前将意志托付给第十班。夕日红后于第四次忍界大战前夕生下阿斯玛的遗腹女猿飞未来。 第四次忍界大战中，阿斯玛被药师兜以秽土转生形式复活，后被其弟子第十班合力击败并封印，最后随秽土转生的解除而灵魂回归净土。"]],
            "x_leiying":["male","shen",4,["duanbi","leishu","zhongbao"],["des:艾，日本动漫《火影忍者》中雷之国云隐村的四代目雷影，夜月一族，八尾人柱力奇拉比的义兄[1]。 性格暴躁冲动，身体健壮并以速度著称，全身在“雷遁护体”的保护下，速度和防御力都堪称强劲，在第四次忍界大战中担任忍者联军的统帅，后来在第四部队战场中与其余四影大战宇智波斑，结果被斑击败，恢复伤势后前往十尾战场支援前线，与其余联军合力击败十尾。"]],
            "x_zhaomeimeng":["female","shen",3,["x_feidun","x_rongdun"],["des:照美冥，日本漫画《火影忍者》及其衍生作品中的女性角色。水之国雾隐村的第五代水影，结束了雾隐在四代目水影执政以来“血雾之村”的恐怖时期，实行和平开放的政策，因而使雾忍者村复兴。实力强大，能够在无水之地中运用自身查克拉、使出足以压制宇智波斑“火遁·豪火灭失”的超强水遁。拥有水、火、土三种查克拉属性（其实还有雷）血继限界“溶遁”和“沸遁”，是唯一一位拥有两种血继限界的忍者。（不包括拥有六道之力的斑，鸣人，佐助等人，六道之力包含所有属性，理论上六道之力拥有者能使用所有血继限界，血继淘汰甚至血继网罗的忍术。）"]],
        },
        translate:{
            itachi:"宇智波鼬",
            genie:"盖聂",
    ...
    card:{
        ...
        if(!target.countCards('he',{type:'equip'})){
            ...
            target.chooseToDiscard({type:'equip'},'弃置一张装备牌或受到一点伤害').ai=function(card){
        ...
        if(!result.bool){
            ...
            "x_xuelunyang":{
                ...
                image:"ext:新武将/x_xuelunyang.png",
                enable:true,
                selectTarget:-1,
                filterTarget:function (card,player,target){
        return target==player;
        ...
        translate:{
            jiuwei:"九尾",
            "jiuwei_info":"当场上有其他角色使用【桃】时，你可以弃掉【九尾】，阻止【桃】的结算并将其收为手牌",
            zbfs:"蒸危暴威",
            "zbfs_info":"延时性锦囊牌，若判定结果为方片，则目标角色受到X点无来源的火焰伤害并随机弃置X张牌（X为此锦囊判定结果为方片的次数）。判定完成后，将此牌移动到下家的判定区里。",
            "x_houzi":"猴子",
            "x_houzi_info":"猴子偷桃：当场上有其他角色使用【桃】时，你可以弃掉【猴子】，阻止【桃】的结算并将其收为手牌",
            "x_mianju":"漩涡面具",
            "x_mianju_info":"锁定技，武将牌不能被翻面",
            "x_kuwu":"苦无",
            "x_kuwu_info":"锁定技，每当你使用【杀】造成一次伤害，受伤角色须弃置一张牌",
            "x_shoulijian":"手里剑",
            "x_shoulijian_info":"出牌阶段，对一名距离1以外的角色使用，令其弃置一张装备牌或受到一点伤害",
            "x_xuelunyang":"写轮眼",
            "x_xuelunyang_info":"回合开始阶段，你可以选择一名角色，然后获得其一项技能，直到回合结束",
        },
        list:[["heart","9","jiuwei"],["diamond","5","x_houzi"],["spade","9","x_mianju"],["spade","7","x_kuwu"],["club","4","x_shoulijian"],["heart","2","x_xuelunyang"],["diamond","4","x_shoulijian"]],
    },
    skill:{
        skill:{
            "蛮王":{
    ...
    player.turnOver();
        ...
        if(result.bool){          
            target.turnOver();
            player.storage.yuedu3=target;
            player.addTempSkill('yuedu3','phaseAfter');         
            target.addTempSkill('fengyin','phaseAfter');      
            target.addTempSkill('yuedu2','phaseAfter');           
            event.finish();
        }
    },
                ai:{
        ...
        player.draw();
            ...
            if(!get.is.altered('shanjie')) return true;
        },
                },
            },
            luoxuan:{
    ...
    return ui.create.dialog([list,'vcard']);                                        
        ...
        if(result.bool){                       
           ...
           event.target.addSkill('x_yan');
           event.target.markSkill('x_yan');              
        }
        else{
            player.draw();
            event.target.removeSkill('x_yan');
            event.target.unmarkSkill('x_yan');            
        }
    },
                ai:{
        ...
        trigger.finish();
            ...
            reshenwei:{
                ...
                viewAs:{
                    ...
                    suit:"diamond",
                    number:1,
                    cards:[{"node":{"image":{},"info":{},"name":{},"name2":{},"background":{},"intro":{},"range":{}},"storage":{},"vanishtag":[],"_uncheck":[],"suit":"diamond","number":1,"name":"zhuque","nature":"fire","cardid":"6044250369","clone":{"name":"zhuque","suit":"diamond","number":1,"node":{"name":{},"info":{},"intro":{},"background":{},"image":{}},"_transitionEnded":true,"timeout":3435},"original":"h","_transform":"translateX(336px)","timeout":3412}],
                },
                filter:function (event,player){
    ...
    'step 1'
      ...
      player.chooseToDiscard(1,'he',true);    
        ...
        player.storage.refengyin=false;
         ...
         player.chooseTarget('请选择一名目标，令其技能失效',get.prompt('refengyin'),function(card,player,target){
            return target!=player;
        }).set("ai",function(target){
                return get.damageEffect(target,player,player);
...
if(event.num1>event.num2){      
    ...
    if(player.storage.fenshen>=9){
        player.die();
                ...
                mod:{
                    globalFrom:function (from,to,distance){
            return distance-from.storage.fenshen;
        },
                },
                ai:{
                    order:7,
...
var skill=trigger.player.skills.randomGet()
    ...
    var chat=['吃我一拳，看是你的骨头硬还是我的拳头硬','点解？点解？点解要逼我出手？'].randomGet();
        ...
        skillprompt += "<p>"+get.translation("xuxibie_info")+"</p>";
        ...
        "step 2"
        if(result.bool){
            player.logSkill("xuxibie",result.targets[0]);
        ...
        skillprompt += "<p>"+get.translation("xuqingshang_info")+"</p>"
        player.chooseBool(skillprompt).ai=function(){
            return true;
        };
        "step 1"
        ...
        check=(num>=1);
        player.chooseTarget(get.prompt('newkuilei'),[1],function(card,player,target){
        ...
        "step 1"
        if(result.bool){            
            player.logSkill('newkuilei',result.targets);
        ...
        player.addTempSkill('huomeng2',{player:"phaseBegin"});
        player.markSkill('huomeng2',{player:"phaseBegin"});
    ...
    event.finish();
        ...
        next.set('prompt',get.prompt('duoyang',trigger.player));
        "step 1"
        if(result.control=='夺取写轮眼'){
            player.logSkill('duoyang',trigger.player);
    ...
    var chat=['为了忍界，为了木叶，我不会让你们活着离开','就算是死都要拉个人来陪葬'].randomGet();
        ...
        return game.hasPlayer(function(current){
            return current!=player&&current.countCards('h')>0;
                ...
                content:function (){
        "step 0"
        player.chooseTarget(get.prompt('baozi'),function(card,player,target){
            if(target==player) return false;
            var nh=target.countCards('h');
            if(nh==0) return false;
            if(get.is.altered('baozi')){
        ...
        player.draw(2);
        "step 2"  
            player.addTempSkill('duanbi2','phaseEnd');                   
    },
                ai:{
                    order:9,
                    result:{
   ...
   if(player.hp>1&&player.num('h',{name:'tao'})) return 3;
    ...
    player.recover();
        ...
        var chat=['我所有的努力，都是为了复活母亲','抱歉！我并不是你的意志，而是母亲辉夜姬的意志'].randomGet();
            player.say(chat);         
        player.storage.yinmou=true;         
        var name1=targets[0].name;
        var name2='huiye';
        targets[0].reinit(name1,name2,false);
        targets[0].recover();
        player.recover();        
        player.removeSkill('yinmou');
    },
                ai:{
                    order:5,
                    result:{
        ...
        player.draw();
            ...
            xinzhenjun:{
                ...
                content:function (){
"step 0"
player.chooseTarget(get.prompt('xinzhenjun'),function(card,player,target){
...
if(result.bool){
game.delay();
player.logSkill('xinzhenjun',result.targets);
...
event.target.draw(event.num1);
    ...
    player.$skill('天之御中','fire','red','avatar');
        ...
        for(var i=0;i<game.players.length;i++){
            if(player.hp>0){
                game.players[i].storage.tianyu=list.randomGet();
                players.push(game.players[i]);
            };
        };
        for(var i=0;i<players.length;i++){
            if(player.hp>0){
                game.swapSeat(players[i],players[i].storage.tianyu);
                delete players[i].storage.tianyu;
            };
        };
    },
                ai:{
        ...
        if(get.suit(event.card)+'2'==event.choice){
            ...
            zibao:{
                ...
                marktext:"爆",
                init:function (player){
        player.storage.zibao=false;
    },
                filter:function (event,player){
        return !player.storage.zibao;
    },
                content:function (){
        'step 0'
var chat=['只有瞬间的绚丽，才是艺术','这个艺术，终会得到世人的赞美'].randomGet();
        ...
        player.awakenSkill('zibao');
        player.unmarkSkill('zibao');
        player.storage.zibao=true;
        for(var i=0;i<game.players.length;i++){
        ...
        target.addTempSkill('lunxue','phaseAfter');         
        player.discardPlayerCard(target,"he",true);   
    },
                ai:{
                    order:13,
        ...
        if(card){
            var name=card.name;              
            if(event.name=='tao'&&get.itemtype(event.cards)=='cards'&&get.position(event.cards[0])=='d'&&event.player!=player&&name&&name.indexOf('jiuwei')!=-1) return true;
        }
        return false;
    },
                check:function (event,player){
...
var chat=['我有那么谦虚？看来也不错','岚遁……'].randomGet();
        ...
        switch(get.suit(result.card)){
            case 'spade':
                player.addTempSkill('x_landun1');
                break;
            case 'heart':
                player.addTempSkill('x_landun2');
                break;
            case 'club':
                player.addTempSkill('x_landun3');
                break;
            case 'diamond':
                player.addTempSkill('x_landun4');
                break;
        }     
        'step 2'
        player.addTempSkill('x_landun5');
        player.addTempSkill('x_landun6');       
    },
                ai:{
                    result:{
                        player:1,
...
var chat=['我都说了，要打倒我，就要先找到蜃的实体','海市蜃楼，风景这边独好……'].randomGet();
        ...
        switch(get.color(result.card)){
            case 'black':
                player.addTempSkill('x_chunshu1',{player:'phaseUseBegin'});                
                player.addTempSkill('x_chunshu3',{player:'phaseUseBegin'});               
                player.markSkill('x_chunshu1',{player:'phaseUseBegin'});                
                break;
            case 'red':
                player.addTempSkill('x_chunshu2',{player:'phaseUseBegin'});                                
                player.addTempSkill('x_chunshu3',{player:'phaseUseBegin'});               
                player.markSkill('x_chunshu2',{player:'phaseUseBegin'});
                break;           
        }             
    },
                ai:{
       ...
       trigger.cancel();       
            ...
            "x_zhengbao":{
                ...
                animationColor:"fire",
                init:function (player){
        player.storage.x_zhengbao=false;
    },
                filter:function (event,player){
        if(player.storage.x_zhengbao) return false;
        if(event.type=='dying'){
            if(player!=event.dying) return false;
            return true;
        }           
        ...
        player.awakenSkill('x_zhengbao');
        player.storage.x_zhengbao=true;       
        'step 1'
        player.link(false);
        'step 2'
        player.turnOver(false);                   
        player.useCard(game.createCard('zbfs','diamond',4),player);      
        player.addSkill('x_lianbao');
        player.addSkill('x_shuipao');       
    },
                ai:{
                    order:0.5,
                    skillTagFilter:function (player){
            ...
            if(player.hp>0) return false;
                ...
                return 0;
                    ...
                    threaten:function (player,target){
            if(!target.storage.x_zhengbao) return 0.6;
        },
                },
                intro:{
                    content:"limited",
 ...
 var chat=['这个术能无限爆炸','下一波爆炸已准备好了'].randomGet();
        ...
        return false;
         ...
         var chat=['日后再说，管他什么报应','不入虎穴，焉得虎子？'].randomGet();
            player.say(chat);                                                            
        player.storage.x_yinguo++;                
        player.markSkill('x_yinguo');      
    },
                intro:{
                    content:"mark",
                },
        ...
        game.countPlayer(function(current){
            if(current!=player&&!current.hasSkill('x_yinguo')){
                player.line(current,'green');
                current.addSkill('x_yinguo');
            }
        });
    },
            },
        ...
        return event.targets.length==1&&event.player!=player&&player.countCards('h')>=1;
                ...
                content:function (){
        "step 0"
        var next=player.chooseToDiscard(get.prompt('x_kongjing',trigger.player),1);
        ...
        next.logSkill=['x_kongjing',trigger.player];
        "step 1"
        if(result.bool){
        ...
        for(var i=0;i<game.players.length;i++){
            if(game.players[i]!=player){
                ...
                content:function (){            
          for(var i=0;i<game.players.length;i++){                                                       
                if(game.players[i].storage.x_yinguo<1){
                event.finish();
            }                                       
            else{                                                            
              game.players[i].damage(game.players[i].storage.x_yinguo);
              game.players[i].storage.x_yinguo=false;      
              game.players[i].unmarkSkill('x_yinguo');     
var chat=['如是因，如是果，你们这一生对他人所做的伤害，都会一次过回到自己身上','让我代天惩罚你们……神技•因果转轮！'].randomGet();
 ...
 var chat=['尸骨脉～十指穿弹','尸骨脉～柳之舞','尸骨脉～椿之舞','尸骨脉～唐松之舞','尸骨脉～铁线花之舞','尸骨脉～八重葎之舞','尸骨脉～早蕨之舞'].randomGet();
        ...
        return !_status.auto&&event.player==game.me&&!event.player.isMad()&&!_status.connectMode;
                ...
                content:function (){       
        player.addSkill('shuochang_use');
        player.addSkill('shuochang_cancel');
        ui.auto.hide();
    },
                subSkill:{
                    use:{
            ...
            player.say(chat); 
                player.draw();     
                    ...
                    cancel:{
                        ...
                        content:function (){           
                ui.auto.show();
                player.removeSkill('shuochang_use');
                player.removeSkill('shuochang_cancel');
            },
                        sub:true,
                        forced:true,
                        popup:false,
 ...
 player.useCard({name:'sha'},trigger.target,false);       
        ...
        return player.hp>0;
                ...
                init:function (player){
        player.storage.x_fengyin=false;
    },
                intro:{
                    content:"limited",
                },
                content:function (){
         'step 0'        
         player.storage.x_fengyin=true; 
         player.chooseTarget('请选择一名目标，令其技能失效',get.prompt('x_fengyin'),function(card,player,target){
            return target!=player;
        }).set("ai",function(target){
                return get.damageEffect(target,player,player);
        ...
        'step 1'   
         player.unmarkSkill('x_fengyin')          
          if(result.bool){                
            player.$skill('尸鬼封尽','fire','red','avatar'); 
                 var chat=['只要有树叶飞舞的地方，火就会燃烧，火的影子会照耀着村子','忍者最强的力量不是在学会所有忍术之后得到，而是在保护自己最珍贵的东西时才会显露出来'].randomGet();
            player.say(chat);              
            for(var i=0;i<result.targets.length;i++){
                player.logSkill('x_fengyin',result.targets);            
                result.targets[i].clearSkills();                                   
                player.loseHp(player.hp);
                player.removeSkill('x_fengyin');                                                         
        };
          };
...
player.revive(player.maxHp)
    ...
    var chat=['这一天终究还是来了','就算是死，我也要回来索命'].randomGet();
        player.say(chat); 
        player.addTempSkill('x_fuchou2',{player:'phaseEnd'});        
        var num2=player.maxHp-player.hp;                   
        trigger.num+=num2;                   
    },
                ai:{
      ...
      if(result.suit=='spade'){  
       ...
       player.damage('fire','nosource');              
        ...
        var chat=['我的天照黑炎能烧毁我所看到的一切，烧毁之前绝不熄灭','没想到我连天照都用上了'].randomGet();
            player.say(chat); 
            trigger.player.addSkill('x_yan');
            trigger.player.markSkill('x_yan');                  
    },
            },
            "retianzhao1":{
                enable:"phaseUse",
        ...
        return player.hp<player.maxHp-1;
                ...
                content:function (){
        player.awakenSkill('xtishen');
        player.recover(player.maxHp-player.hp);
        player.draw(player.maxHp-player.hp);                
        player.storage.xtishen=true;
    },
            },
            "x_houzi":{
                trigger:{
        ...
        if(card){
            var name=card.name;              
            if(event.name=='tao'&&get.itemtype(event.cards)=='cards'&&get.position(event.cards[0])=='d'&&event.player!=player&&name&&name.indexOf('x_houzi')!=-1) return true;
        }
        return false;
    },
                check:function (event,player){
   ...
   "step 2"
    ...
    player.$gain2(trigger.cards);
        ...
        return !event.iwhile;
                ...
                content:function (){          
        'step 0'
        player.chooseControl('超重岩之术','超轻岩之术','cancel2').set('prompt',get.prompt('tiancheng')).set('ai',function(){
      ...
      var chat=['是神的指令杀了你','你是黑暗，在没有光明的世界中花儿只能枯萎'].randomGet();
        ...
        next.set('prompt',get.prompt('x_zhishu',trigger.player));
        "step 1"
        if(result.control=='式纸之舞'){
            player.logSkill('x_zhishu',trigger.player);
        ...
        var chat=['杀……哈哈……把你们通通杀光','君麻吕，佐助，你们都是我信赖的朋友'].randomGet();
            ...
            xmudun:{
                group:["xmudun_use","xmudun_respond"],
                filter:function (event,player){
        return false;
    },
                viewAs:{
                ...
                subSkill:{
                    use:{
                        ...
                        chooseButton:{
                            dialog:function (event,player){
                    player.storage.xmudun = [
                        ui.cardPile.childNodes[0],                                        
                    ];
                    return ui.create.dialog('木遁',player.storage.xmudun,'hidden');
                },
                            filter:function (button,player){
                    var evt=_status.event.getParent();
                    if(evt&&evt.filterCard){
            ...
            xdaiban:{
                mode:["identity"],
                group:["xdaiban_live","xdaiban_die"],
                subSkill:{
                    live:{
                        mode:["identity"],
                        trigger:{
        ...
        player.addAdditionalSkill('xdaiban',list);
        player.storage.zhuSkill_xdaiban=list;
                'step 1'
                for(var j=0;j<game.zhu.getSkills().length;j++){
                    ...
                    die:{
                        ...
                        forced:true,
                        content:function (){
                game.zhu.removeSkill('xdaiban_1');
            },
                        sub:true,
                    },
                },
      ...
      var chat=['卡卡西前辈，你怎么看？','各位，摆好阵势，保持队型……我先摸一张牌！'].randomGet();
        ...
        player.draw();
            ...
            "x_shouyu":{
                audio:"ext:新武将:2",
                group:["x_shouyu_effect1","x_shouyu_effect2"],
                subSkill:{
                    "effect1":{
                        trigger:{
                            global:"damageBegin",
  ...
  var chat=['玉之义……代表着村里的小孩子们，他们是村子的未来与希望','这一次，就让我来挡住狂风暴雨吧！'].randomGet();
        player.say(chat);
                    player.logSkill("x_shouyu",trigger.player);
                    trigger.player = player;
                }
                else {
                    event.finish();
        ...
        trigger.directHit=true;       
         var chat=['这就是风属性查克拉的威力','将查克拉凝聚于刀上，将无坚不摧'].randomGet();
            ...
            "x_jinshao":{
                ...
                enable:"phaseUse",
                filter:function (event,player){
        return !player.storage.x_jinshao;
    },
                filterTarget:function (card,player,target){
        return player!=target;
    },
        ...
        player.say(chat);
        player.storage.x_jinshao=true;
        player.awakenSkill('x_jinshao');       
        ...
        if(!result.bool){
            target.damage(2,'fire');
                ...
                init:function (player){
        player.storage.x_jinshao=false;
    },
                intro:{
                    content:"limited",
                },
        ...
        return dialog;
                ...
                content:function (){
        'step 0'
        player.chooseTarget(get.prompt2('x_xuelunyang'),function(card,player,target){
            var names=[];
            if(target.name&&!target.isUnseen(0)) names.add(target.name);
            if(target.name1&&!target.isUnseen(0)) names.add(target.name1);
            if(target.name2&&!target.isUnseen(1)) names.add(target.name2);
        ...
        if(result.bool){
            event.target=result.targets[0];
            player.logSkill('x_xuelunyang',event.target);
        }
        else{
            event.finish();
        }
        ...
        if(event.isMine()){
            ...
            event._result=event.skillai(lib.skill.x_xuelunyang.createDialog(player,target,true));
        }
        'step 3'
        _status.imchoosing=false;
        if(event.dialog){
        ...
        translate:{
            ...
            xiangfu:"降服",
            "xiangfu_info":"觉醒技，回合开始阶段，若你的体力上限不少于7，你立即死亡。",
            xiongqi:"雄起",
            ...
            lunhui:"轮回",
            "lunhui_info":"<font color=#F0F>轮回天生</font> 限定技，出牌阶段你可弃置两张[桃]并选择一名已阵亡角色，令其复活，其体力回复至X，并摸X张的牌（X为该角色的体力上限），然后你将你的武将牌翻面",
            tianyin:"天引",
            "tianyin_info":"<font color=#F0F>万象天引</font> 回合结束阶段限一次，你可以随机获得每名角色区域内的一张牌，然后你将你的武将牌翻面",
            yuedu:"月读",
            "yuedu_info":"出牌阶段限一次，你可选择一名角色进行拼点，若你赢，则该角色翻面，并且直到回合结束，你与该角色距离为1，其非锁定技失效，不能使用或打出牌。",
            xuzuo:"须佐",
            "xuzuo_info":"<font color=#F0F>须佐能乎</font> 锁定技，你的防御距离+1，当你有手牌时，防止受到属性伤害，无手牌时，防止受到非属性伤害。",
            tianzheng:"天征",
            "tianzheng_info":"<font color=#F0F>神罗天征</font> 当你即将受到伤害，若伤害来源体力比你高，你可弃置一张黑色手牌令伤害-1，当你即将造成伤害，若对方体力值比你高，你可弃置一张红色手牌令此伤害+1",
            baiyan:"白眼",
            "baiyan_info":"出牌阶段限一次，你可以观看一名角色的手牌，然后你可以获得其中一张红色手牌",
            zhangshu:"掌术",
            "zhangshu_info":"你的回合外，每当你使用、打出、失去或被弃置一张牌时，你立即摸一张牌。",
            shanjie:"闪捷",
            "shanjie_info":"<font color=#F0F>飞雷神</font> 锁定技，你的防御距离始终+1。你使用的卡牌无距离限制",
            luoxuan:"螺旋",
            "luoxuan_info":"<font color=#F0F>螺旋丸</font> 出牌阶段，你可以将任意一张装备牌当做任意一张普通锦囊牌使用，每阶段限一次。",
            yandun:"炎遁",
            "yandun_info":"出牌阶段限一次，你可与一名有手牌的角色进行拼点，若你赢，你观看其手牌并对目标角色造成一点火焰伤害，并令其获得“黑炎”标记。若你没赢，你可以摸一张牌，你令其失去“黑炎”标记（佐助能控制天照之炎的形态变化） ",
            rexuzuo:"须佐",
            ...
            shazang:"沙葬",
            "shazang_info":"<font color=#F0F>沙瀑大葬</font> 当你起码满足以下两个条件之一时：1、使用的牌为最后一张手牌；2、你的体力值为1。（一尾守鹤）你使用的牌可无视距离，此时你使用的【杀】【决斗】【火攻】【过河拆桥】【顺手牵羊】可指定任意名目标角色。你使用杀时若手牌数或体力值小于2，此杀可无视对方防具且不可闪避",
            juefang:"绝防",
            ...
            refengyin:"封印",
            "refengyin_info":"<font color=#F0F>尸鬼封尽</font> 限定技，回合结束阶段你可令任意一名角色永久失去当前的所有技能，然后你进入濒死状态。",
            leique:"雷切",
            ...
            zhuansheng:"转生",
            "zhuansheng_info":"<font color=#F0F>秽土转生</font> 出牌阶段限一次，你可弃置一张【桃】并选择一名已阵亡角色，令其复活，其体力回复至2，摸两张的牌，并且身份阵营与你一致（若你为主公则视阵营为忠臣），然后你失去一点体力上限（限身份局）",
            fenshen:"分身",
            "fenshen_info":"<font color=#F0F>影分身之术</font> 出牌阶段限一次，你可以用一张手牌与任意名角色同时拼点，然后依次结算拼点结果，若你赢，没赢的角色随机弃置一张牌；若你拼点没赢，你摸一张牌，并获得一个“分身”标记。锁定技，你的进攻距离+X（X为你的“分身”标记数，若你有9个或以上的分身标记时，你因耗尽九尾的查克拉而立即死亡）",
            xianyan:"献眼",
            "xianyan_info":"当你死亡时，可令一名其他角色随机获得你的除此技能外的另一项其他技能，然后该角色回复一点体力。",
            bamen:"八门",
            "bamen_info":"<font color=#F0F>八门遁甲</font> 锁定技，出牌阶段开始时，若你的体力值为4或更少，你视为拥有技能“马术”（朝孔雀）；若你的体力值为3或更少，你视为拥有技能“咆哮”（昼虎）；若你的体力值为2或更少；你视为拥有技能“伏骑”（夕象）；若你的体力值为1，你视为拥有技能“暗箭”（夜凯）",
            fuzhi:"复制",
            "fuzhi_info":"游戏开始所有角色摸牌后、准备阶段开始前和结束阶段，你可以选择一名与你上一次以此法选择不同的存活角色，获得其所有技能，直到下一次更改为止（部分技能除外）",
            resizhan:"死战",
            "resizhan_info":"<font color=#F0F>八门遁甲</font> 限定技，出牌阶段开始前，你可以摸8张牌，然后你的体力上限调整至1",
            chendun:"尘遁",
            "chendun_info":"出牌阶段限一次，你可与一名有手牌的角色进行拼点，若你赢，目标角色失去一点体力上限，并摸一张牌。若你没赢，目标角色受到一点伤害",
            lunmu:"轮墓",
            "lunmu_info":"<font color=#F0F>轮墓边狱</font> 你每造成1点伤害后，可以立即获得受到伤害的角色的一张牌。",
            rebusi:"邪徒",
            "rebusi_info":"<font color=#F0F>不死之身</font> 锁定技，在你死亡前，若你的体力值不大于0，亮出牌堆顶的一张牌并置于你的武将牌上，若此牌的点数与你武将牌上已有的牌点数均不同，则你回复体力至2，若出现重复点数则你死亡。只要你的武将牌上有牌，你的手牌上限便与这些牌数量相等",
            zhenxing:"震星",
            "zhenxing_info":"<font color=#F0F>天碍震星</font> 出牌阶段限一次，你可以将两张【杀】当作【万箭齐发】使用",
            zhoushu:"咒术",
            "zhoushu_info":"<font color=#F0F>死司凭血</font> 当你造成伤害时，你可选择标记任意一名其他角色，然后该技能进入冷却状态，直到被诅咒的该角色死亡方可再次发动。当你受到伤害后，同时被诅咒的角色视为受到来源为你的等量的伤害，直到其死亡",
            "zhoushu3":"咒术",
            "zhoushu3_info":"",
            "zhoushu2":"咒术",
            "zhoushu2_info":"",
            yiyuan:"遗志",
            "yiyuan_info":"<font color=#F0F>完全体须佐能乎</font> 限定技，觉醒技，濒死阶段，若你有手牌，你可以将所有手牌交给一名体力上限大于你的其他角色，调整你的体力上限至与该角色相同，然后回复体力至体力上限，并获得技能“轮墓”（轮墓：你每造成1点伤害后，可以立即获得受到伤害的角色的一张牌。）",
            xinxuzuo:"须佐",
            "xinxuzuo_info":"<font color=#F0F>须佐能乎</font> 锁定技，出牌阶段你使用的【杀】可指定的目标上限+1（双头须佐能乎）。当你有手牌时，防止受到属性伤害，无手牌时防止受到非属性伤害。",
            xinbaiyan:"白眼",
            ...
            hengjian:"横剑",
            "hengjian_info":"<font color=#F0F>横贯八方</font> 出牌阶段，你可以将两张杀当杀使用，此杀无视距离，可以指定任意名目标",
            qianshou:"千手",
            "qianshou_info":"<font color=#F0F>千手神通</font> 当一名角色使用的锦囊牌指定了至少两名角色为目标时，你可以令此牌对其中任意名角色无效。（能阻止我的，只有千手柱间。——宇智波斑）",
            xianti:"仙体",
            ...
            zongjian:"纵剑",
            "zongjian_info":"<font color=#F0F>百步飞剑</font> 你使用的【杀】无距离限制；当你使用【杀】指定一个目标后，你可以根据下列条件执行相应的效果：1.其手牌数小于你的手牌数，此【杀】不可被【闪】响应 2.其体力值大于你的体力值，此【杀】伤害+1",
            "zongjian2":"百步飞剑",
            "zongjian2_info":"目标角色的体力值大于等于你的体力值，你可令此【杀】伤害+1",
            guazhang:"卦掌",
            "guazhang_info":"<font color=#F0F>八卦掌</font> 每当你于出牌阶段内使用的牌与此阶段你使用的上一张牌的花色相同时，你可以摸一张牌",
            reguaili:"怪力",
            "reguaili_info":"每两轮限一次，你可以失去任意点体力并摸X张牌，然后直到回合结束，你使用的【杀】造成的伤害+1，你的进攻距离+X，且你可以额外使用X张【杀】（X为你以此法失去的体力值），若你在发动此技能后，每杀死一名其他角色，你延迟一步增加一点体力上限",
            "reguaili2":"爆发",
            "reguaili2_info":"你使用的【杀】造成的伤害+1，你的进攻距离+X，且你可以额外使用X张【杀】",
            mudun:"木遁",
            "mudun_info":"当你需要使用或打出牌时，你可以观看牌堆顶的两张牌，若其中有你可以使用或打出的牌，则你可以使用或打出之（初代火影的木遁能瞬间凭空创造出一片森林）",
            baihao:"百豪",
            "baihao_info":"<font color=#F0F>阴封印•百豪之术</font> 出牌阶段结束或濒死状态时，若你已受伤，你可选择回复体力至体力上限，然后失去一点体力上限（创造再生•百豪之术是能提高自愈能力但会减少寿命的禁术）",
            xianren:"仙人",
            "xianren_info":"<font color=#F0F>蛤蟆仙人</font> 觉醒技，准备阶段开始时，若你的“忍”的数量不小于3，你减1点体力上限，选择一项：1、回复1点体力；2、摸两张牌。然后你获得技能“仙术”。（自来也发动仙术须先通灵两个蛤蟆仙人到自己的身体上，所以发动需忍耐很长的时间）",
            renfa:"忍法",
            ...
            changsheng:"永生",
            "changsheng_info":"濒死阶段，你可摸一张牌，你可以与一名有手牌的其他角色拼点，若你赢，你与该角色交换体力值（伤害来源转为你）并且你增加一点体力上限（不得超过5）；若你拼点没赢，你回复体力至体力上限并摸一张牌，然后你失去一点体力上限并翻面（一个像蛇一样难缠的家伙）",
            rechendun:"尘遁",
            "rechendun_info":"出牌阶段限一次，你可与一名有手牌的角色进行拼点，若你赢，目标角色失去一点体力上限，并摸一张牌。若你没赢，目标角色受到一点伤害",
            wuchen:"无尘",
            "wuchen_info":"<font color=#F0F>无尘迷塞</font> 锁定技，当你没有手牌时，你防止受到任何伤害",
            rexianshu:"仙术",
            "rexianshu_info":"锁定技，当你失去最后的手牌时，你可以摸牌补至你当前体力的张数，然后回复一点体力。",
            shunsheng:"瞬身",
            "shunsheng_info":"<font color=#F0F>瞬身止水</font>锁定技，回合结束后， 你和一名随机角色交换位置",
            "renfa3":"忍法",
            "renfa3_info":"出牌阶段，你可以用任意数量的手牌与等量的“忍”交换，每阶段限一次。",
            reshouhu:"守护",
            "reshouhu_info":"<font color=#F0F>别天神</font> 限定技，出牌阶段，你可以弃置一张红色手牌，选择一名存活的非主公角色，令其身份与你一致（你不为主公限身份局），并且其之后的一切行动受你控制，然后你（止水）自杀身亡（无伤害来源）",
            linghua:"灵化",
            "linghua_info":"<font color=#F0F>灵化之术</font> 出牌阶段，你可弃置一张基本牌，选择一名存活角色，令其与你交换角色（仅游戏玩家交换），然后你（加藤断）翻面，失去此技能，获得技能【回魂】，并对目标造成一点伤害，结算完后当前回合立即结束",
            aiyuan:"爱愿",
            ...
            jiaoji:"鲛肌",
            "jiaoji_info":"<font color=#F0F>无尾尾兽</font> 每名角色的回合限一次，当一名其他角色受到一次伤害，你可以选择回复1点体力或摸一张牌",
            shuilao:"水牢",
            "shuilao_info":"<font color=#F0F>水牢之术</font> 一名其他角色的准备阶段，若你的体力值不大于你的装备区的牌数，你可以与该角色拼点，若你赢，该角色本回合使用的牌不能指定除该角色外的角色为目标（类似队友鼬的月读封锁对方行动）",
            relianhua:"莲华",
            "relianhua_info":"锁定技，摸牌阶段摸牌时，你额外摸X张牌（X为游戏轮数）；你的手牌上限等于体力上限。",
            rexuanfeng:"旋风",
            "rexuanfeng_info":"<font color=#F0F>木叶旋风</font> 锁定技，若你的手牌数是全场唯一最多的，你造成的伤害+1",
            jiaodan:"鲛弹",
            "jiaodan_info":"<font color=#F0F>水遁•水鲛弹之术</font> 出牌阶段限一次，你可以弃置X张牌对一名其他角色造成1点伤害(X为该角色的体力值)。若你以此法令该角色进入濒死状态，则濒死状态结算后你摸一张牌",
            "jiaodan2":"鲛弹",
            "jiaodan2_info":"",
            "jiaodan3":"鲛弹",
            "jiaodan3_info":"",
            leidun:"雷盾",
            "leidun_info":"<font color=#F0F>最强之盾</font> 锁定技，游戏开始时，你的体力上限改为X或X-1（X为其他角色的体力上限之和的一半（向下取整））",
            yingmo:"影模",
            "yingmo_info":"<font color=#F0F>影子模仿术</font> 当你造成一次伤害，可随机获得此受伤害角色的一项技能，直到你下个出牌阶段开始才解除",
            zhimou:"智谋",
            ...
            wanshe:"召唤",
            "wanshe_info":"<font color=#F0F>通灵万蛇</font> 你拼点时，可以改为用牌堆顶的一张牌进行拼点；当你拼点的牌亮出后，若此牌颜色为黑色，则点数视为K",
            kuilei:"傀儡",
            "kuilei_info":"<font color=#F0F>傀儡术</font> 当其他角色阵亡后，你获得阵亡角色的随机一个技能，每当有角色阵亡可随机变动获得的技能",
            baiji:"百机",
            "baiji_info":"<font color=#F0F>赤秘技•百机操演</font> 每当你造成或受到一次伤害，你可随机获得一张装备牌",
            refenxin:"焚心",
            ...
            jinshu:"禁术",
            "jinshu_info":"<font color=#F0F>禁术宗师</font> 锁定技，回合开始阶段，你随机获得技能【分身】（鸣人）、【闪捷】（波风水门）、【转生】（药师兜）中的一个，直到下一次回合开始。",
            baoli:"爆力",
            ...
            "baofu2":"爆符",
            "baofu2_info":"<font color=#F0F>互乘起爆符</font> 当一名角色受到火焰伤害后，你可以弃置一张方片花色的牌，然后对该角色或与其距离为1以内的一名角色造成等量的火焰伤害。（单张起爆符即可无限连续通灵出起爆符集中于一点无限连续爆炸）",
            baofu:"爆符",
            "baofu_info":"<font color=#F0F>互乘起爆符</font> 出牌阶段限一次，你可以对一名其他角色造成1点火焰伤害。每当一名角色受到火焰伤害后，你可以弃置一张方片花色的牌，然后对该角色或与其距离为1的一名角色造成等量的火焰伤害。（单张起爆符即可无限连续通灵出起爆符集中于一点无限连续爆炸）",
            rejieyuan:"竭缘",
            "rejieyuan_info":"当你对一名其他角色造成伤害时，若其体力值大于或等于你的体力值，你可弃置一张黑色手牌令此伤害+1；当你受到一名其他角色造成的伤害时，若其体力值大于或等于你的体力值，你可弃置一张红色手牌令此伤害-1。",
            wuyin:"雾隐",
            "wuyin_info":"<font color=#F0F>雾隐之术</font> 锁定技，当你的武将牌背面朝上时，你防止受到任何伤害",
            ansha:"暗杀",
            ...
            reshuilao:"水牢",
            "reshuilao_info":"<font color=#F0F>水牢之术</font> 一名其他角色的准备阶段，若你的武将牌背面朝上，你可以与该角色拼点，若你赢，你将你的武将牌翻面，该角色本回合使用的牌不能指定除该角色外的角色为目标",
            huadie:"化蝶",
            "huadie_info":"锁定技，若你的手牌数是全场唯一最多的，你造成的伤害+1",
            beihua:"倍化",
            "beihua_info":"<font color=#F0F>三色药丸 倍化之术</font> 出牌阶段限3次，你可以展示牌堆顶的X张牌，其中每有一张梅花牌，你回复1点体力（梅花引蝶）然后你将这些牌收入手牌，并且弃牌阶段你的手牌上限－X（X为你发动倍化的次数）",
            "beihua2":"倍化",
            "beihua2_info":"",
            zhuanxin:"转心",
            "zhuanxin_info":"<font color=#F0F>心转心之术</font> 出牌阶段限一次，你可以弃置一张红桃手牌，选择一名存活的其他角色，令其与你交换手牌",
            reyiliao:"医疗",
            "reyiliao_info":"当有角色进入濒死状态时，你可以展示该角色的一张牌：若此牌为装备牌，则该角色弃掉这张牌并回复体力至1，若为非装备牌，你获得之。",
            diedun:"蝶遁",
            "diedun_info":"<font color=#F0F>梦蝶之遁</font> 当你的体力值小于2或手牌数小于体力值时，其他角色计算与你的距离为无限远",
            renzhong:"人宗",
            "renzhong_info":"<font color=#F0F>万物回春</font> 出牌阶段限一次，你可以获得所有其他角色区域内的一张牌，然后你须为所有存活的角色每人逐个派发一张手牌",
            yuanyu:"怨虞",
            "yuanyu_info":"<font color=#F0F>地怨虞</font> 你每杀死一名角色后，你永久获得该角色的随机一项技能，然后你依次增加一点体力上限（不得超过5）和回复一点体力",
            zhongquan:"重拳",
            "zhongquan_info":"锁定技，若你的体力不是全场最高（含之一），你无视对方的防具，并且造成的伤害+1",
            xuxibie:"惜别",
            "xuxibie_info":"当你失去装备区的牌时（包括替换和弃置等），你可以摸一张牌并弃置其他角色区域内的一张牌。",
            xuqingshang:"情殇",
            "xuqingshang_info":"当你受到伤害后，你可以弃置一张牌并声明一种牌的类型，然后从牌堆顶亮出五张牌，获得其中与你所声明类型相同的牌，将其余的牌置入弃牌堆。",
            "探囊":"探囊",
            "探囊_info":"锁定技，若你已受伤，你的进攻距离+X（X为你已损失体力值）",
            newkuilei:"傀儡",
            "newkuilei_info":"<font color=#F0F>傀儡术</font> 每当你失去一张装备区的牌，你可以获得1名其他角色的一张手牌或判定区的牌",
            huomeng:"惑梦",
            "huomeng_info":"<font color=#F0F>伊邪那歧</font> 结束阶段，你可以弃置一张装备区的牌，对自己施加终极幻术，然后进入伊邪那歧梦境：直到下回合开始，你防止受到非属性伤害（佐助可破之）",
            "huomeng2":"梦境",
            "huomeng2_info":"（伊邪那歧）锁定技，你防止受到非属性伤害",
            duoyang:"夺眼",
            "duoyang_info":"每当你造成伤害后，你可以选择一项：1、获得受到伤害的角色装备区里的一张牌（你的装备区相应位置不能有此类装备牌）；2、摸一张牌。",
            kongbo:"空波",
            "kongbo_info":"<font color=#F0F>风遁•真空波</font> 锁定技，若你的装备区有牌，你无视对方的防具",
            sixiang:"四象",
            "sixiang_info":"<font color=#F0F>四象封印</font> 当你死亡时，若伤害来源与你距离为1，你可令其失去当前的所有技能，直到游戏结束。",
            chengyi:"承艺",
            "chengyi_info":"（继承赤砂之竭的傀儡）当其他角色的牌因弃置而进入弃牌堆时，若其中含有非梅花花色的装备牌，你可以获得所有这些非梅花的牌。",
            "yuedu2":"幻术",
            "yuedu2_info":"直到回合结束，该角色不能使用或打出手牌",
            "yuedu3":"月读",
            "yuedu3_info":"与其距离为1",
            baozi:"孢子",
            "baozi_info":"<font color=#F0F>孢子之术</font> 回合外，当你需要打出一张卡牌【杀】或者【闪】时，你可以观看任意一名其他角色的手牌并将其视为你的手牌打出（白绝有柱间细胞，故类似千手柱间的技能木遁，兼有侦察能力）",
            leishu:"雷速",
            "leishu_info":"锁定技，你使用的任何卡牌无数量限制，可选择距离不大于此牌点数的目标",
            duanbi:"断臂",
            "duanbi_info":"<font color=#F0F>雷犁热刀</font> 出牌阶段，你可以流失一点体力并摸两张牌，若如此做，你获得以下效果：1、无视对方的防具，2、你使用的【决斗】造成的伤害+1",
            "duanbi2":"断臂",
            "duanbi2_info":"（雷犁热刀）你无视对方防具，并且你使用的【决斗】造成的伤害+1",
            yiwu:"易物",
            "yiwu_info":"<font color=#F0F>易物变化</font> 限定技，出牌阶段，你可以弃置一张【无懈可击】，选择一名存活的其他角色，令你的武将牌与技能均同化与目标角色一致，若如此做，你摸两张牌并先失去发动此技能前的角色“绝”的所有技能",
            juneng:"聚能",
            "juneng_info":"（查克拉之祖）锁定技，每名角色的回合限一次：当一名角色受到伤害，你摸一张牌；当一名角色回复一点体力，若你已受伤，你回复一点体力",
            yinmou:"阴谋",
            "yinmou_info":"限定技，出牌阶段，你可以弃置一张【闪电】，选择一名存活的其他角色，令其将武将牌更换为大筒木辉夜，然后你与其各回复一点体力（黑绝阴阳遁•精神附体•同化，谋划复活母亲辉夜）",
            zhongbao:"重瀑",
            "zhongbao_info":"<font color=#F0F>雷我暴弹</font> 锁定技，当你于回合内重复使用同名卡牌时，你摸一张牌",
            xinzhenjun:"镇军",
            "xinzhenjun_info":"准备阶段，你可以弃置一名手牌数多于体力值的角色的X张牌（X为其手牌数和体力值之差），然后选择一项：1.你弃置等同于其中非装备牌数量的牌；2.其摸等量的牌。",
            "juneng2":"聚能",
            "juneng2_info":"（回收查克拉）锁定技，每名角色的回合限一次，当一名角色受到伤害，你摸一张牌",
            tianyu:"天御",
            "tianyu_info":"<font color=#F0F>天之御中</font> 出牌阶段限一次，若存活人数大于2，你可以令所有其他角色与随机角色交换位置",
            baodun:"爆遁",
            "baodun_info":"出牌阶段限一次，你可以选择一名有手牌的其他角色，然后声名一种花色，并展示该角色随机一张手牌，若两者花色一致，你获得该手牌；若花色不一致，其受到一点火焰伤害，并且你可弃置其一张牌",
            zibao:"自爆",
            "zibao_info":"限定技，出牌阶段，你可令所有其他角色受到一点火焰伤害，若如此做，与你距离为1的角色额外受到一点火焰伤害，然后你死亡。",
            huigu:"灰骨",
            "huigu_info":"<font color=#F0F>共杀灰骨</font> 出牌阶段限一次，你可以令攻击范围内的一名有手牌的其他角色展示一下其手牌，该角色陷入瞳术中：直到回合结束，其不能使用或打出牌。然后你须弃置其一张牌",
            feiniao:"飞鸟",
            "feiniao_info":"锁定技，你的防御距离+1",
            lunxue:"轮写",
            "lunxue_info":"不能使用或打出牌",
            jiuwei:"九尾",
            "jiuwei_info":"当场上有其他角色使用【桃】时，你可以弃掉【九尾】，阻止【桃】的结算并将其收为手牌",
            shayu:"砂雨",
            "shayu_info":"<font color=#F0F>砂铁时雨</font> 当你失去一张装备区的牌后，你可以选择一项：1、摸一张牌；2、弃置一名其他角色的一张牌",
            xfeixian:"飞翔",
            "xfeixian_info":"锁定技，你的防御距离+1",
            xfenlie:"分裂",
            "xfenlie_info":"（分裂、通灵）出牌阶段限一次，你可以弃置所有手牌并摸两张牌",
            "reguaili3":"爆发",
            "reguaili3_info":"你每杀死一名角色后，你增加一点体力上限",
            "x_bizhu":"臂助",
            "x_bizhu_info":"每当一名角色流失体力后，你与其可以各摸一张牌。",
            "x_landun":"岚遁",
            "x_landun_info":"<font color=#F0F>杀的集大成者</font>出牌阶段限一次，你可以进行一次判定，若判定结果为：黑桃，你使用的【杀】造成的伤害+1；红桃，你使用的【杀】可以额外指定一名角色成为目标；梅花，你使用【杀】后可弃置对方一张牌；方片，你使用【杀】的上限次数+1。然后你本回合使用的【杀】无距离限制且无法闪避",
            "x_landun3":"岚遁",
            "x_landun3_info":"你使用【杀】后可弃置对方一张牌",
            "x_landun1":"岚遁",
            "x_landun1_info":"使用的【杀】造成的伤害+1",
            "x_landun2":"岚遁",
            "x_landun2_info":"你使用的【杀】可额外指定一名角色",
            "x_landun4":"岚遁",
            "x_landun4_info":"你使用的【杀】次数上限+1",
            "x_landun5":"岚遁",
            "x_landun5_info":"你使用的【杀】无距离限制",
            "x_landun6":"岚遁",
            "x_landun6_info":"你使用的【杀】无法闪避",
            "x_chunshu":"蜃术",
            "x_chunshu_info":"<font color=#F0F>海市蜃楼</font>结束阶段，你可以进行一次判定，若判定结果为：黑色，你防止受到锦囊牌的伤害；红色：你不能成为【杀】的目标，且均防止受到属性伤害，直到下个出牌阶段开始为止",
            "x_chunshu1":"锦囊",
            "x_chunshu1_info":"锁定技，你防止受到锦囊牌的伤害",
            "x_chunshu2":"禁杀",
            "x_chunshu2_info":"锁定技，你不能成为【杀】的目标",
            "x_zhengbao":"蒸爆",
            "x_zhengbao_info":"<font color=#F0F>蒸危暴威</font>限定技，觉醒技，当你处于濒死状态时，你可以丢弃你所有判定区的牌，并复原你的武将牌，摸两张牌，体力上限改为4点并回复体力至3点（<font color=#F0F>令二代土影感到头痛的术，故调上限克尘遁</font>），然后你使用一张“蒸危暴威”卡牌，获得技能“循爆”、“水炮”",
            "x_chunshu3":"属性",
            "x_chunshu3_info":"锁定技，你防止受到属性伤害",
            "x_shuipao":"水炮",
            "x_shuipao_info":"<font color=#F0F>水铁炮之术</font> 出牌阶段限一次，你可以弃置一张装备区的牌，对一名其他角色造成1点伤害",
            "x_lianbao":"循爆",
            "x_lianbao_info":"回合开始时，如果场上角色的判定区内没有【蒸危暴威】，你可以使用一张【蒸危暴威】",
            tuci:"突刺",
            "tuci_info":"<font color=#F0F>地狱突刺</font>锁定技，你使用的杀造成的伤害+X（X为你损失的体力值的25%进位取整）",
            "x_yinguo":"因果",
            "x_yinguo_info":"锁定技，你使用的杀造成一次伤害后，你获得一枚“因果”标记",
            "x_zhuanlun":"转轮",
            "x_zhuanlun_info":"锁定技，游戏开始所有角色摸牌后，你令所有其他角色获得技能“因果”（因果：锁定技，你使用的杀造成一次伤害后，你获得一枚“因果”标记）",
            "x_kongjing":"空镜",
            "x_kongjing_info":"<font color=#F0F>空镜映月</font>每当你成为其他角色的某张卡牌的惟一目标时，你可以弃置一张手牌，将使用者与目标对调",
            "x_chenjie":"惩戒",
            "x_chenjie_info":"<font color=#F0F>因果转轮</font> 出牌阶段限一次，你可令场上所有拥有“因果”标记的角色受到X点来源为你的伤害，若如此做，你须先受到一点伤害，然后其“因果”标记数量清零（X为该角色的“因果”标记个数）",
            "x_zhuzhan":"助战",
            "x_zhuzhan_info":"<font color=#F0F>长生界神力•生死轮回限</font>当一名角色处于濒死状态时，你可以亮出牌堆顶的一张牌，若该牌为红色牌，则该角色回复一点体力，然后将这张红色牌置入弃牌堆；若该牌为黑色牌，你获得之",
            "x_gu":"骨舞",
            "x_gu_info":"<font color=#F0F>尸骨脉</font> 出牌阶段限一次，你可将所有手牌发动以下效果：所有其他角色须打出两张【闪】响应，否则其受到一点雷属性伤害",
            "x_zhouyin":"咒印",
            "x_zhouyin_info":"<font color=#F0F>地之咒印</font> 当其他角色准备阶段开始时，若其手牌数大于你的手牌数，你可以摸一张牌",
            shuochang:"说唱",
            "shuochang_info":"出牌阶段开始时，你可以令你此阶段内每种牌名的牌限使用一次。若如此做，你使用的牌没距离限制，且每当你于此阶段内使用牌时，你摸一张牌",
            "x_xianhua":"仙化",
            "x_xianhua_info":"锁定技，其他角色在弃牌阶段若有弃牌，你摸一张牌，否则你回复一点体力<font color=#F0F>类似咒印且配合君麻吕</font> ",
            "x_leidao":"雷刀",
            "x_leidao_info":"<font color=#F0F>绝牛•雷犁热刀</font>当其他角色使用一张非转化的【杀】指定目标且结算后，你可对其视为再使用一张【杀】<font color=#F0F>配合四代雷影</font>",
            "x_huizhan":"挥战",
            "x_huizhan_info":"每两轮的出牌阶段限一次，你可以弃置所有手牌，指定一个目标，从你开始场上所有角色依次视为对其使用一张【杀】，直到其体力值不大于1",
            "x_fengyin":"封印",
            "x_fengyin_info":"<font color=#F0F>尸鬼封尽</font> 限定技，回合结束阶段你可令任意一名角色永久失去当前的所有技能，然后你进入濒死状态。",
            "x_yuanmo":"猿魔",
            "x_yuanmo_info":"<font color=#F0F>召唤猿魔</font> 锁定技，结束阶段，你可以将手牌数补至当前体力的张数<font color=#F0F>猿飞日斩是千手柱间弟子，故技能类似仙体</font> ",
            "x_fuhuo":"复活",
            "x_fuhuo_info":"<font color=#F0F>亡者之印</font> 锁定技，当你阵亡时，你增加一点体力上限，阵亡一分钟后，你自动复活，体力回复至体力上限",
            "x_fuchou":"复仇",
            "x_fuchou_info":"锁定技，摸牌阶段摸牌时，你额外摸X张牌（X为你损失的体力值）；你使用的【杀】额外造成Y点的伤害（Y为你的损失的体力值的一半向下取整）",
            "x_fuchou2":"复仇",
            "x_fuchou2_info":"锁定技，你使用的【杀】额外造成Y点伤害（Y为你的损失的体力值的一半向下取整）",
            "x_yan":"黑炎",
            "x_yan_info":"锁定技，开始阶段，若你有此“黑炎”标记，你须进行判定，若判定结果为黑桃，你受到一点无来源的火焰伤害（直到该角色阵亡，否则黑炎不会消失）",
            "retianzhao2":"天照",
            "retianzhao2_info":"锁定技，当你造成火焰伤害时，你令该受伤害的角色获得“黑炎”标记",
            "retianzhao1":"天照",
            "retianzhao1_info":"出牌阶段，你可将普通杀当火杀使用",
            retianzhao:"天照",
            "retianzhao_info":"出牌阶段，你可将普通杀当火杀使用。锁定技，当你造成火焰伤害时，你令该受伤害的角色获得“黑炎”标记",
            baoxing:"爆星",
            "baoxing_info":"<font color=#F0F>地爆天星</font>出牌阶段限一次，你可以将所有的手牌当一张【南蛮入侵】使用",
            xtishen:"替身",
            "xtishen_info":"限定技，准备阶段开始时，你可以将体力回复至体力上限，然后你每以此法回复1点体力，便摸一张牌。",
            "x_houzi":"猴子",
            "x_houzi_info":"猴子偷桃：当场上有其他角色使用【桃】时，你可以弃掉【猴子】，阻止【桃】的结算并将其收为手牌",
            tiancheng:"天秤",
            "tiancheng_info":"当你亮出拼点牌后，你可令此牌点数+X（超重岩之术）或点数－X（超轻岩之术）。（X为存活角色数）",
            "x_jizhu":"计诛",
            "x_jizhu_info":"<font color=#F0F>克制宇智波带土</font> 当你受到伤害后，你可以依次弃置任意角色区域内的共计X张牌。（X为你的装备区的牌数与损失的体力值之和） ",
            "x_zhishu":"纸术",
            "x_zhishu_info":"<font color=#F0F>式纸之舞</font> 当一名其他角色翻面或判定牌生效后，你可以选择一项：1、将该角色装备区里的一张牌移动至你装备区里的相应位置（不可替换）；2、摸一张牌。<font color=#F0F>克制宇智波带土，配合漩涡长门</font> ",
            "x_kuangbao":"狂暴",
            "x_kuangbao_info":"<font color=#F0F>空气炮</font> 当一名角色受到火属性或雷属性伤害后，你可令其受到等量的无属性伤害<font color=#F0F>配合佐助与君麻吕</font> ",
            xmudun:"木遁",
            "xmudun_info":"当你需要使用或打出牌时，你可以观看牌堆顶的一张牌，若其中有你可以使用或打出的牌，则你可以使用或打出之",
            xdaiban:"代班",
            "xdaiban_info":"锁定技，身份模式下，当你存活时，你先获得当前主公的主公技，然后主公的主公技失效",
            "xdaiban_1":"代班",
            "xdaiban_1_info":"当前的主公的主公技失效",
            "x_duizhang":"队长",
            "x_duizhang_info":"锁定技，当场上有角色拼点或武将牌被横置／重置后，你摸一张牌",
            "x_shouyu":"守玉",
            "x_shouyu_info":"当其他角色因成为【杀】的目标而受到伤害时，你可以弃置一张基本牌，将此伤害转移给你；锁定技，当你受到一次伤害后，你可以摸x张牌(x为你已损失的体力值)",
            "x_fengdun":"风遁",
            "x_fengdun_info":"锁定技，当你的手牌数大于你的体力值，你使用的杀无法闪避",
            "x_jinshao":"烬烧",
            "x_jinshao_info":"<font color=#F0F>灰烬烧</font>限定技。出牌阶段，你可令任意名其他角色依次选择一项：弃置2X张牌；或受到两点火焰伤害。(X为该角色装备区里牌的数量且至少为1)",
            "x_rongdun":"溶遁",
            "x_rongdun_info":"<font color=#F0F>溶怪之术</font>每名角色的回合限一次，当其他角色使用装备牌时，你可取消之，然后你摸一张牌",
            "x_feidun":"沸遁",
            "x_feidun_info":"<font color=#F0F>沸遁•巧雾之术</font>出牌阶段限一次，你可以观看一名其他角色的牌，然后你可以用一张手牌替换其中的一张牌，若如此做，该角色受到一点火焰伤害",
            "x_mianju":"漩涡面具",
            "x_mianju_info":"锁定技，你的武将牌不能被翻面",
            "x_kuwu":"苦无",
            "x_kuwu_info":"锁定技，每当你使用【杀】造成一次伤害，受伤角色须弃置一张牌",
            "x_xuelunyang":"写轮眼",
            "x_xuelunyang_info":"回合开始阶段，你可以选择一名角色，然后获得其一项技能，直到回合结束",
    ...
    intro:"本扩展包含部分三国改版新武将和火影忍者、秦时明月、武庚纪（封神纪）等作品的人物，强度略高，基本上都有配音。使用前请先打开兼容模式。更多介绍请看〈帮助〉",
    ...
    version:"20180423",
},files:{"character":["x_zhaomeimeng.jpg"],"card":["x_xuelunyang.png"],"skill":[]}}})