game.import("extension",function(lib,game,ui,get,ai,_status){return {name:"新武将",content:function (config,pack){
    ...
    character:{
        character:{
            ...
            Sukincen:["male","shen",3,["xuqingshang","xuxibie"],["des:原武将、技能设计源于橙续缘的作品《吧友列传》扩展。人物为吧友形象。原技能名分别为“探索”和“拷贝”。小苏与Sukincen皆为化名，本人不姓苏。"]],
        },
        translate:{
            itachi:"宇智波鼬",
            genie:"盖聂",
...
var skill=trigger.player.skills.randomGet()
    ...
    version:"20171118",
},files:{"character":["Sukincen.jpg"],"card":[],"skill":[]}}})