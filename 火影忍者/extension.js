game.import("extension", function(lib, game, ui, get, ai, _status) {
    return {
        ...
        content: function(config, pack) {
            ...
            // ---------------------------------------brawl------------------------------------------//
            var hyrzMusic = null;
            var isHyrzMusicPlaying = false;

            function playHyrzMusic() {
                if (ui.backgroundMusic) {
                    ui.backgroundMusic.pause();
                }

                if (!hyrzMusic) {
                    hyrzMusic = new Audio(lib.assetURL + 'extension/火影忍者/hyrz_music.mp3');
                    hyrzMusic.loop = true;
                }

                hyrzMusic.play().catch(function(e) {
                    console.log("播放火影忍者音乐失败:", e);
                });

                isHyrzMusicPlaying = true;
            }

            function stopHyrzMusic() {
                if (hyrzMusic && isHyrzMusicPlaying) {
                    hyrzMusic.pause();
                    isHyrzMusicPlaying = false;
            ...
            game.showHYRZCharacterGallery = function() {
                ...
                Page.prototype = {
                    show: function() {
                        ...
                        this.body.show();
                        this.body.classList.add('hyrz_gallery_dialog');
                        return this;
                    },
                    hide: function() {
                        this.body.hide();
                ...
                var title = ui.create.div('.hyrz_gallery_title', '火影忍者');
                var closeButton = ui.create.div('.hyrz_gallery_close_btn', '×');
                ...
                var galleryContainer = ui.create.div('.hyrz_gallery_container');
                var slider = ui.create.div('.hyrz_gallery_slider');
                ...
                for (var i = 0; i < characters.length; i++) {
                    ...
                    var charCard = ui.create.div('.hyrz_gallery_char_card');

                    charCard.style.width = cardWidth + 'px';
                    charCard.style.height = cardHeight + 'px';

                    var charImg = document.createElement('img');
                    charImg.classList.add('hyrz_gallery_char_img');
                    ...
                    var charName = ui.create.div('.hyrz_gallery_char_name', get.translation(charId) || charId);
            ...
            game.hyrzCharacterCover = function() {
                ui.system.style.display = 'none';
                ui.menuContainer.style.display = 'none';
                ui.click.configMenu();
                playHyrzMusic();

                var coverPage = ui.create.div('#hyrz_page.hyrz_detail_page.hyrz-cover-page');
                coverPage.id = 'hyrz_cover_page';
                document.body.appendChild(coverPage);

                var coverContainer = ui.create.div('#hyrz_mainContainer.hyrz_detail_container.hyrz_cover_container');

                var title = ui.create.div('#hyrz_title.hyrz_detail_title.hyrz_cover_title', '火影忍者');
                ...
                var closeButton = ui.create.div('#hyrz_closeButton.hyrz_detail_close.hyrz_cover_close', '×');
            ...
            game.hyrzCharacter = function() {
                ...
                game.replayhyrz = function(fn, dir) {
                    try {
                        if (!fn) {
                ...
                function playSkillAudio(charName, skillName) {
                    try {
                        ...
                        if (window._hyrz_skill_last_play &&
                            window._hyrz_skill_last_play.key === playKey &&
                            Date.now() - window._hyrz_skill_last_play.time < 500) {
                            console.log('技能配音防重播：忽略重复播放', charName, skillName);
                            return;
                        }

                        window._hyrz_skill_last_play = {
                            key: playKey,
                            time: Date.now()
                        };
                ...
                function playDieAudio(charName, packKey, extNameWithTags) {
                    try {
                        ...
                        if (window._hyrz_last_die_play &&
                            window._hyrz_last_die_play.key === playKey &&
                            Date.now() - window._hyrz_last_die_play.time < 300) {
                            console.log('阵亡配音防重播：短时间内重复点击，忽略');
                            return;
                        }

                        window._hyrz_last_die_play = {
                            key: playKey,
                            time: Date.now()
                        };
                        ...
                        setTimeout(function() {
                            try {
                                ...
                                for (var i = 0; i < cleanExtNames.length; i++) {
                                    ...
                                    game.replayhyrz(cleanCharName, extName);
                                }
                ...
                function loadCharacterImage(imgElement, charName, isDetailPage) {
                    ...
                    imagePaths.push(lib.assetURL + 'extension/火影忍者/' + charName + '.jpg');
                    imagePaths.push(lib.assetURL + 'extension/火影忍者/image/character/' + charName + '.jpg');
                ...
                function showSkillCode(skillName, charName) {
                    ...
                    var existingPage = document.querySelector('#hyrz_page.hyrz_code_page');
                    if (existingPage) {
                        existingPage.remove();
                    }

                    var skillPageBg = ui.create.div('#hyrz_page.hyrz_code_page');
                    ...
                    var skillMainContainer = ui.create.div('#hyrz_mainContainer.hyrz_code_container');

                    var skillRightPanel = ui.create.div('#hyrz_rightPanel.hyrz_code_panel');

                    var skillCloseButton = ui.create.div('#hyrz_closeButton.hyrz_code_close', '×');
                    ...
                    var skillTitle = ui.create.div('#hyrz_title.hyrz_code_title');
                    ...
                    var skillContentContainer = ui.create.div('#hyrz_contentContainer.hyrz_code_content');
                ...
                function createCharacterIntro(charName, introClass, packName) {
                    ...
                    var extNameWithTags = lib.translate['huoyingrenzhe_character_config'];

                    var dComps = {
                        header: (function() {
                            var imgElement = ui.create.div('.hyrz_intro_header');
                            ...
                            imgElement.addEventListener('click', function(e) {
                                ...
                                detailPage.body = ui.create.div('#hyrz_page.hyrz_detail_page');
                                var detailContainer = ui.create.div('#hyrz_mainContainer.hyrz_detail_container');
                                var detailPanel = ui.create.div('#hyrz_rightPanel.hyrz_detail_panel');
                                var closeButton = ui.create.div('#hyrz_closeButton.hyrz_detail_close', '×');
                                closeButton.addEventListener('click', function() {
                                    detailPage.hide();
                                ...
                                //var title = ui.create.div('#hyrz_title.hyrz_detail_title');
                                //title.innerHTML = packName + ' - ' + get.translation(charName);
                                // 详细页标题获取角色所属的真实分类
                                var realCategory = packName; 
                                if (lib.characterSort && lib.characterSort.huoyingrenzhe) {
                                    for (var catId in lib.characterSort.huoyingrenzhe) {
                                        var list = lib.characterSort.huoyingrenzhe[catId];
                                        if (Array.isArray(list) && list.indexOf(charName) !== -1) {
                                            realCategory = get.translation(catId) || catId;
                                            break;
                                        }
                                    }
                                }
                                var title = ui.create.div('#hyrz_title.hyrz_detail_title');
                                title.innerHTML = realCategory + ' - ' + get.translation(charName);
                                detailPanel.appendChild(title);
                                var contentContainer = ui.create.div('#hyrz_contentContainer.hyrz_detail_content');

                                var infoContainer = ui.create.div('.hyrz_detail_page_info_container');
                                var infoStr = "";
                                ...
                                var infoText = ui.create.div('.hyrz_detail_page_info_text', infoStr);
                                infoContainer.appendChild(infoText);

                                var infoIconWrapper = ui.create.div('.hyrz_detail_page_info_icon_wrapper');
                                var infoIcon = ui.create.div('.hyrz_detail_page_info_icon');

                                infoIcon = addDieAudioClick(infoIcon, charName, 'huoyingrenzhe', extNameWithTags);

                                infoIconWrapper.appendChild(infoIcon);
                                infoContainer.appendChild(infoIconWrapper);
                                contentContainer.appendChild(infoContainer);

                                var headerContainer = ui.create.div('.hyrz_detail_header_container');
                                var detailHeader = ui.create.div('.hyrz_detail_header');
                                ...
                                var introContainer = ui.create.div('.hyrz_detail_page_intro_container');
                                var introText = ui.create.div('.hyrz_detail_page_intro_text');
                                try {
                ...
                game.import('character', function() {
                    var huoyingrenzhe = {
                        ...
                        skill: {
                            ...
                            "huoying_xinyiliao": {
                                ...
                                check: function(event, player) {
                                    ...
                                    if (player.countCards('h', {
                                            ...
                                            name: 'jiu'
                                        }) && event.player == player)) return 0;
                                    return get.attitude(player, event.player) > 0;
                                },
                                frequent: "check",
                                filter: function(event, player) {
                                    return event.player.hp <= 0 && player.countCards('h', {
                                        type: 'basic'
                                    });
                                },
                                prompt: function(event, player, target) {
                            ...
                            "huoying_zhuzheng": {
                                ...
                                content: function() {
                                    ...
                                    if (result.bool) {
                                        target.link();
                                        target.addTempSkill('huoying_zhuzheng2', {
                                            player: 'phaseBegin'
                                        });
                                    }
                                    if (!result.bool) {
                                ...
                                content: function() {
                                    ...
                                    for (var i = 0; i < game.players.length; i++) {
                                        if (game.players[i] != player) {
                                            var cards = game.players[i].getCards('e', {
                                                type: 'equip'
                                            });
                                            for (var j = 1; j < 6; j++) {
                            ...
                            "huoying_daoji": {
                                ...
                                content: function() {
                                    'step 0'
                                    player.chooseCard('h', true, '选择使用一张装备牌', {
                                        type: 'equip'
                                    }).ai = function(card) {
                                        return 8 - get.value(card);
                                    };
                            ...
                            "huoying_ganzhi": {
                                ...
                                content: function() {
                                    ...
                                    for (var i = 0; i < game.players.length; i++) {
                                        if (game.players[i].countCards('h', 'tao') > 0 || game.players[i].countCards('h', {
                                                type: 'equip'
                                            }) > 0) {
                                            player.draw();
                                        }
                            ...
                            "huoying_weishou": {
                                ...
                                content: function() {
                                    ...
                                    if (result.bool) {
                                        ...
                                        var target = result.targets[0];
                                        player.line(target, 'green');
                                        target.addTempSkill('huoying_weishou2', {
                                            player: 'phaseUseBegin'
                                        });
                                        player.useCard({
                                            name: 'sha'
                            ...
                            */
                                ...
                                content: function() {
                                    ...
                                    if (result.bool) {
                                        ...
                                        player.chooseButton([get.prompt('huoying_rechendun'), [list, 'vcard']]).set('filterButton', function(button) {
                                            ...
                                            switch (button.link[2]) {
                                                case 'equip1':
                                                    return 5 + 6 * Math.random();
                                                case 'equip2':
                                                    return 7 + 6 * Math.random();
                                                case 'equip3':
                                                    return 6 + 6 * Math.random();
                                                case 'equip4':
                                                    return 4 + 6 * Math.random();
                                                case 'equip5':
                                                    return 4 + 6 * Math.random();
                                                default:
                            ...
                            "huoying_yingfu": {
                                ...
                                content: function() {
                                    ...
                                    player.chooseButton(get.prompt('huoying_yingfu'), true, [
                                        [list, 'vcard']
                                    ]).set('filterButton', function(button) {
                                        return true;
                                    }).set('ai', function(button) {
                            ...
                            */
                            ...
                            "huoying_baoli": {
                                ...
                                content: function() {
                                    ...
                                    if (result.bool) {
                                        ...
                                        player.say(chat);
                                        player.addTempSkill('huoying_baoli2', {
                                            player: 'phaseBefore'
                                        });
                                        player.addTempSkill('huoying_baoli3', {
                                            player: 'phaseBefore'
                                        });
                                    }
                                },
                            ...
                            "huoying_baofu2": {
                                ...
                                direct: true,
                                filter: function(event, player) {
                                    return event.nature == 'fire' && player.countCards('he', {
                                        suit: 'diamond'
                                    }) > 0;
                                },
                                content: function() {
                            ...
                            "huoying_huomeng": {
                                ...
                                content: function() {
                                    ...
                                    if (result.bool) {
                                        ...
                                        player.addTempSkill('huoying_huomeng2', {
                                            player: 'phaseBegin'
                                        });
                                        player.markSkill('huoying_huomeng2', {
                                            player: 'phaseBegin'
                                        });
                                ...
                                ai: {
                                    ...
                                    result: {
                                        player: function(player) {
                                            ...
                                            if (player.hp > 2 && player.countCards('he', {
                                                    name: 'zhuge'
                                                })) return 1.5;
                            ...
                            "huoying_yinmou": {
                                ...
                                filter: function(event, player) {
                                    ...
                                    return num == 0 && player.countCards('h', {
                                        name: 'shandian'
                                    }) > 0;
                                },
                                filterCard: {
                            ...
                            "huoying_chunshu": {
                                ...
                                content: function() {
                                    ...
                                    switch (get.color(result.card)) {
                                        case 'black':
                                            player.addTempSkill('huoying_chunshu1', {
                                                player: 'phaseUseBegin'
                                            });
                                            player.addTempSkill('huoying_chunshu3', {
                                                player: 'phaseUseBegin'
                                            });
                                            player.markSkill('huoying_chunshu1', {
                                                player: 'phaseUseBegin'
                                            });
                                            break;
                                        case 'red':
                                            player.addTempSkill('huoying_chunshu2', {
                                                player: 'phaseUseBegin'
                                            });
                                            player.addTempSkill('huoying_chunshu3', {
                                                player: 'phaseUseBegin'
                                            });
                                            player.markSkill('huoying_chunshu2', {
                                                player: 'phaseUseBegin'
                                            });
                                            break;
                                    }
                            ...
                            "huoying_huizhan": {
                                ...
                                content: function() {
                                    ...
                                    event.targets.sort(lib.sort.seat);
                                    'step 1'
                                    if (event.num < event.targets.length && target.isAlive()) {
                                        event.targets[event.num].line(target, 'fire');
                            ...
                            "huoying_baoxing": {
                                ...
                                content: function() {
                                    ...
                                    player.chooseButton([get.prompt('huoying_baoxing'), [list1.concat(list2), 'vcard']]).set('filterButton', function(button) {
                                        ...
                                        switch (button.link[2]) {
                                            case 'du':
                                                return 6 + 17 * Math.random();
                                            case 'sha':
                                                return 1 + 17 * Math.random();
                                            case 'tao':
                                                return 5 + 17 * Math.random();
                                            case 'jiu':
                                                return 3 + 17 * Math.random();
                                            case 'shan':
                                                return 4 + 17 * Math.random();
                                            case 'wuzhong':
                                                return 5 + 17 * Math.random();
                                            case 'shunshou':
                                                return 4.5 + 17 * Math.random();
                                            case 'guohe':
                                                return 2 + 17 * Math.random();
                                            case 'jiedao':
                                                return 3 + 17 * Math.random();
                                            case 'juedou':
                                                return 3 + 17 * Math.random();
                                            case 'taoyuan':
                                                return 8 + 17 * Math.random();
                                            case 'wugu':
                                                return 4 + 17 * Math.random();
                                            case 'huogong':
                                                return 4 + 17 * Math.random();
                                    ...
                                    if (result.bool) {
                                        ...
                                        event.dialog = ui.create.dialog(get.translation(player) + '<div class="text center">选择了' + get.translation(result.links[0][2]), [
                                            [result.links[0][2]], 'vcard'
                                        ]);
                                ...
                                ai: {
                                    ...
                                    result: {
                                        player: function(player) {
                                            ...
                                            if (player.hp < 2 && player.hasSkill('huoying_lunhui') && !player.countCards('h', {
                                                    name: ['tao', 'jiu']
                                                })) return 0;
                                            return 1;
                                        },
                                ...
                                ai: {
                                    ...
                                    result: {
                                        player: function(player) {
                                            ...
                                            if (player.getStat().card.sha == 0 && num > 0 && game.roundNumber > 1 && player.countCards('h') > 2 && player.countCards('h', {
                                                    name: 'sha'
                                                }) > 0) return 1;
                                            return 0;
                                        },
                                                ...
                                                if (get.value(hs[i]) <= 6) {
                                                    switch (hs[i].number) {
                                                        case 13:
                                                            return -1;
                                                        case 12:
                                                            if (player.storage.huoying_fenshen + num <= 8) return -1;
                                                            break;
                                                        case 11:
                                                            if (player.storage.huoying_fenshen + num <= 7) return -1;
                                                            break;
                                                        default:
                                                            if (hs[i].number > 5 && player.storage.huoying_fenshen + num <= 8) return -1;
                                                    }
                                                }
                                            }
                                            return 0;
                            ...
                            "huoying_jinshu": {
                                ...
                                content: function() {
                                    ...
                                    switch (Math.floor(Math.random() * 3)) {
                                        case 0:
                                            if (lib.skill.huoying_fenshen) {
                                                player.addSkill('huoying_fenshen');
                                                player.storage.huoying_jinshu = 'huoying_fenshen';
                                                player.popup('huoying_fenshen');
                                            }
                                            break;
                                        case 1:
                                            if (lib.skill.huoying_shanguang) {
                                                player.addSkill('huoying_shanguang');
                                                player.storage.huoying_jinshu = 'huoying_shanguang';
                                                player.popup('huoying_shanguang');
                                            }
                                            break;
                                        case 2:
                                            if (lib.skill.huoying_zhuansheng) {
                                                player.addSkill('huoying_zhuansheng');
                                                player.storage.huoying_jinshu = 'huoying_zhuansheng';
                                                player.popup('huoying_zhuansheng');
                                            }
                                            break;
                                    }
                                },
                        ...
                        translate: {
                            ...
                            "huoying_huizhan": "挥战",
                            "huoying_huizhan_info": "每两轮的出牌阶段限一次，你可以弃置所有手牌，指定一个目标，然后场上除该角色外所有角色依次视为对其使用一张火【杀】",
                            "huoying_xfengyin": "封印",
                    ...
                    if (lib.device || lib.node) {
                        for (var i in huoyingrenzhe.character) {
                            huoyingrenzhe.character[i][4].push('ext:火影忍者/' + i + '.jpg');
                        }
                    } else {
                        for (var i in huoyingrenzhe.character) {
                            huoyingrenzhe.character[i][4].push('db:extension-火影忍者:' + i + '.jpg');
                        }
                    }
        ...
        config: {
            ...
            "hyrz_character_gallery": {
                name: '<div class="hyrz_menu">角色画廊</div>',
                clear: true,
                onclick: function() {
                    game.playhyrz('hyrz_danchuang');
            ...
            "hyrz_tujian": {
                name: '<div class="hyrz_menu">角色图鉴</div>',
                "clear": true,
                "onclick": function() {
                    game.playhyrz('hyrz_danchuang');
                    setTimeout(function() {
                        game.hyrzCharacterCover();
                    }, 100);
                },
            },
            "hyrz_brawltujian": {
                name: '<div class="hyrz_menu">乱斗图鉴</div>',
                "clear": true,
                onclick: function() {
                    game.playhyrz('hyrz_danchuang');
