game.import("extension", function (lib, game, ui, get, ai, _status) {
    return {
                ...
                lib.skill._gameStart = {
                    ...
                    content: function () {
                        ...
                        if (_status.mode == 'three' && lib.config['extension_统率三军_actdraw'] == true) {
                            if (_status.color) {
                                game.friendZhu.gain(get.cards());
                                game.enemyZhu.addTempSkill('actlimit');
                            }
                            else {
                                game.enemyZhu.gain(get.cards());
        ...
        help: {
            "统率将池": "<ul><li>2011：标准版武将+风包武将（去除于吉）<li>2012：在2011的基础上，【去除】吕蒙、夏侯惇、张角、曹仁、魏延；【加入】孙坚、孟获、徐晃、庞德、诸葛瑾。<li>2014：在2012的基础上，【去除】许褚、黄忠、孟获、周泰、陆逊；【加入】贾诩、姜维、孙策、文聘；【修改】赵云、关羽、吕布、夏侯惇。<li>2016：【魏】界李典、徐晃、荀攸、邓艾、界曹操、界司马懿、【蜀】界刘备、界张飞、诸葛亮、界赵云、界马超、黄月英、姜维、马谡、【吴】孙权、界甘宁、徐盛、界黄盖、界周瑜、界大乔、界陆逊、孙尚香、丁奉、孙坚、孙策、顾雍、诸葛瑾、小乔、凌统、【群】陈宫、界公孙瓒、界华佗、貂蝉、蔡夫人<li>2017：【魏】界张辽、王异、界许褚、界郭嘉、甄姬、典韦、界李典、荀攸、界司马懿、钟繇、王基、乐进、【蜀】界张飞、诸葛亮、界赵云、界马超、黄月英、姜维、刘谌、黄忠、糜竺、马岱、法正、界徐庶、李严、【吴】孙权、界甘宁、界大乔、孙尚香、丁奉、孙坚、孙策、顾雍、诸葛瑾、小乔、虞翻、韩当、【群】貂蝉、蔡夫人、公孙渊、庞德"
        },
        config: {
            "season": {
                "name": "赛季",
                "init": "2014",
                "intro": "查看将池：其它-帮助-统率将池",
                "item": { "2011": "2011", "2012": "2012", "2014": "2014", "2016": "2016", "2017": "2017" },
                "restart": true
            },
            "card": {
                "name": "卡牌还原",
            ...
            "character": {
                "name": "武将还原",
                "init": true,
                "intro": "ol版本：恂恂、秘计、旋风；标记提示：腹鳞、裸衣、奇制、诈降",
                "restart": true
            },
            "actdraw": {
                "name": "暖色保护",
                "init": true,
                "intro": "暖主起始手牌+1；冷主首轮不能贴乐"
            }
        }, package: {
            character: {
                character: {
