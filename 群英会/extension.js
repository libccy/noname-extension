...
if(!lib.config.cards.contains('xwj_xus_equip')) lib.config.cards.remove('xwj_xus_equip');
	...
	"xwjhelp":{
	"name":"查看帮助","init":"1","item":{"1":"查看帮助","2":"<li>此扩展原名为：新武将。若发现BUG烦请到无名杀设计群：852740627反馈，有技能建议（尤其是《封神纪》的角色）也可联系作者","3":"<li>本扩展汇集了部分三国新将和《火影忍者》、《秦时明月》、《封神纪》等作品的人物，技能强度略高，但各扩展小包内相对平衡。有技能特效，AI聊天妙趣横生，还可联机与好友一起玩！","4":"<li>游戏时最好打开兼容模式，另请关闭“火影忍者”的新版替换开关，否则会有部分武将的技能会缺失"}
	},
},package:{
    character:{
        character:{
