                  ...
                  return !event.player.isAlive();
					   ...
					   content:function(){					
							  ...
							  /*  if(trigger.player.name=='xwj_xhuoying_itachi'){
								   game.playXu('xwj_xhuoying_itachi');					            
						        }*/						 
...
/*		//old:
 ...
 /*			if(config._BackgroundMusic){ if(config._BackgroundMusic=='1'){	game.playBackgroundMusic();	}
						else{
...
skill:{
   ...
   "xwj_xhuoying_yehua2":{                
        ...
        return false;
						...
						content:function(){
							"step 0"
							game.playXu(['xwj_xhuoying_daoji1','xwj_xhuoying_daoji2'].randomGet());		
...
"xwj_xhuoying_qianshou":{            
 ...
 "xwj_xhuoying_guazhang":{
	...
	check:function (event,player){
        ...
        'step 1'
        if(result.bool){    
         /* if(get.is.altered('xwj_xhuoying_rechendun')){  	 
    ...
    player.turnOver();
        ...
        return player.countCards('he',{type:'equip'})>0;
         ...
         position:'he',           
            ...
            player.say(chat);      
             game.playXu(['xwj_xhuoying_luoxuan1','xwj_xhuoying_luoxuan2'].randomGet());
          }
						}
					},
					prompt:function(links,player){
        ...
        return player.countCards('he',{type:'equip'})>0;
         ...
         position:'he',           
            ...
            player.say(chat);      
             game.playXu(['xwj_xhuoying_mrluoxuan1','xwj_xhuoying_mrluoxuan2'].randomGet());
          }
						}
					},
					prompt:function(links,player){
    ...
    'step 1'
      if(result.bool){    
        ...
        event.finish();
                ...
                "step 1"
                if(result.bool){
                game.playXu(['xwj_xhuoying_kkxshenwei1','xwj_xhuoying_kkxshenwei2'].randomGet());  
                    player.moveCard(true);
                }
                else{
                    event.finish();
...
translate:{
   "xwj_xhuoying_shuiyue":"鬼灯水月",
           ...
           "xwj_xhuoying_lunmu":"轮墓",
            ...
            "xwj_xhuoying_mrluoxuan_info":"<font color=#F0F>螺旋丸</font> 出牌阶段，你可以将任意一张装备牌当做任意一张普通锦囊牌使用，每阶段限一次。",
...
characterIntro:{
					...
					"xwj_xqinshi_mozi":"墨翟，即墨子，墨家的创始人，首任巨子，主张“非攻”、“兼爱”、“节用”，曾与公输家族的鲁班较量，化解了一场战争。未在《秦时明月》中正式出现，其事迹仅出于他人口述",
				},   
...
content:function (){
 ...
 translate:{
   ...
   "xwj_xwugeng_ziyu":"子羽",
            ...
            "xwj_xwugeng_qiyi":"起义",
            "xwj_xwugeng_qiyi_info":"当一名角色受到伤害后，若其装备区中没有武器牌，你可令其随机使用一张武器牌",
