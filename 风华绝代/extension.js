...
mod:{
    ...
    globalFrom:function(from,to,distance){
     ...
     return distance-(from.maxHp-from.hp);
         ...
         game.addVideo('storage',player,['qimen',player.storage.qimen]);				
			          	},
            locked:true,
            unique:true,
         intro:{
...
player:['damageEnd','loseHpEnd']
                ...
                unique:true,              
                filter:function (event,player){
                return player.storage.qimen>0&&event.num>0;
                },
                content:function (){               
                   "step 0"
      ...
      translate:{
        ...
        new_jicheng_info:'锁定技，每当一名武将牌被横置的其他角色受到火焰伤害时，你摸一张牌。',
          ...
          leidian_info:"出牌阶段，你可以将一张♠花色的牌当【闪电】置于武将牌上。",
            ...
            qimen:"修行",
            qimen1:"修行",
            "qimen_info":"锁定技，每当受到伤害或流失体力后，你随机获得未加入本局游戏的武将的一个技能（主公技、觉醒技除外〖每局游戏最多发动三次，发动三次之后，你失去此技能直到游戏结束〗）。",
             dunjia:"六甲",
...
return;
      ...
      boss_zhengjiao_append:'<b><p align=center><span class="bluetext" style="color:	#008B00">以下为奋发技，当你体力小于等于3时发动'+'</span></b>',
       ...
       boss_yuhai_info:'<span class="greentext">锁定技'+'</span>，你的回合外，当一名其他角色使用【杀】对你造成伤害后，你立即死亡',
   ...
   lib.skill.guizhen={
    ...
    ai:{
        ...
        player:1,
					...
					effect:{
          player:function(card,player,target){
          if(get.type(card)!='basic'&&card.name!='wuxie'&&card.name!='tiesuo'||card.name=='tiesuo'&&target!=player) return [1,3];
           }
         }
       }
     },	
...
return 10;
   ...
   loopType:2,
    ...
    config:{"tips1":{"name":"<span style=\"font-size:18px;font-weight:550;color: steelblue;font-style: oblique\">欢迎加入无名杀玩家交流群，群号码：658152910</span>","clear":true,"nopointer":true,},
                  enhancement:{
                  name:'属性增强',
                  init:true
                  },
