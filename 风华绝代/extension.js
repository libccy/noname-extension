				...
				skill:{
					...
					sgk_weibao:{
						...
						content:function(){
							...
							'step 2'
							if(get.suit(event.cards)+'2'!=event.choice) target.damage(4);
						},
						ai:{
							order:1,
							result:{
					...
					sgk_choulve:{
						...
						subSkill:{
							shaHit:{
								...
								content:function(){
									player.storage.sgk_choulve.draw(4);
								}
							}
						},
						ai:{
